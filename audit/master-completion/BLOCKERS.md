...
| Notification types in protected books (FIX-11) | help.sap.com 2025.001 prints M1 Maintenance Request, M2 Malfunction Report, M3 Activity Report; corrected in every editable file on 2026-09-24 (`829f56e5`) | the Hebrew layers of Books 1 and 8 and `data/library/pmu-textbook` (source of `pmu-generated.ts`) carry the reversed mapping, and book content is protected | owner decision: approve a one-line correction in those three book sources, or keep them as they are |
