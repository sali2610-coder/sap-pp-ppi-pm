...
| Notification types and Fiori ids in protected books (FIX-11, FIX-12) | help.sap.com 2025.001 prints M1 Maintenance Request, M2 Malfunction Report, M3 Activity Report; corrected in every editable file on 2026-09-24 (`829f56e5`) | the Hebrew layers of Books 1 and 8 and `data/library/pmu-textbook` (source of `pmu-generated.ts`) carry the reversed mapping; `mm-generated.ts` (12) and `ppds-generated.ts` (1), generated from the protected MM and PP/DS textbooks, pair Fiori ids with the wrong app names (FIX-12); book content is protected | owner decision: approve the corrections in those book sources (then regenerate the two academy files), or keep them as they are |
