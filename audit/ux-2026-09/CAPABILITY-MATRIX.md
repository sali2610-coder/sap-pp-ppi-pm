...
| `scripts/verify-reader.mjs` (`verify:reader`) | browser QA | קורא הספרים הישן (/library/): desktop/tablet/mobile | זמין | Gate B | אחרי כל שינוי בספרייה/קורא | הופעל בסבב 3: 69/96; 27 הכישלונות הם סלקטורים שהתיישנו (`nav[aria-label="פרקי הספר"]` — ה-DOM המהודר מציג 'בעמוד זה'; הסקריפט מ-2026-08-11 08:29 קודם לשינויי הקורא באותו יום 13:16/18:35). בדיקה ישירה: 120,411 תווים מצוירים, 0 שגיאות קונסול, 0 גלישה. הקורא הישן לא נגע בסבב זה (משטח קפוא) |
