...
export default function Page() {
  return (
    <div>
      <CenterHeader eyebrow="מרכז הידע · Deep Process Guides" title="מדריכי תהליך מעמיקים" sub={`${PROCESS_GUIDES.length} תהליכי PM/PP/PP-PI מקצה-לקצה — זרימה עסקית, ביצוע שלב-אחר-שלב ב-SAP, טעולות נפוצות, זרימת אבחון, נתיב Debug, Exits/BAdIs, ECC↔S/4, Fiori ודוגמת CBC.`} accent="#0369a1" />
      <CardGrid>
