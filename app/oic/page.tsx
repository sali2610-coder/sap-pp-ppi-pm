...
export default function Page() {
  return (
    <div>
      <CenterHeader eyebrow="Phase 2 · Object Intelligence Center" title="מרכז תבונת אובייקטים" sub={`${OIC_OBJECTS.length} אובייקטי ליבה — תצוגה מאוחדת המקשרת כל אובייקט לטבלאות, T-Codes, BAPIs/FMs, BAdIs/Exits, CDS, תקלות, SAP Notes, נקודות Debug ותרחישי ייצור.`} accent="#4338ca" />
      <CardGrid>
