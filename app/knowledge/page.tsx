...
export default function Page() {
  const centers = [
    ...
    { href: "/evolution/", he: "מרכז אבולוציית T-Codes", title: "Transaction Evolution", tag: "ECC→S/4", tagColor: "#2563eb", desc: "טבלת מיגרציה — T-Codes שהוסרו/לא-אסטרטגיים ב-S/4 + חלופה (MB1A/B/C→MIGO, XK01→BP, MD01→MD01N) + Fiori + השפעה." },
    { href: "/abap/", he: "מרכז מפתח ABAP", title: "ABAP Developer Center", tag: "Dev", tagColor: "#7c3aed", desc: "SE80/SE38/SE37/SE24/SE11/SE84/SAT/ST05/ST12/SCI/ATC — מטרה, דוגמאות, שימוש Debug, טבלאות ואובייקטים." },
    { href: "/quality-audit/", he: "ביקורת איכות ידע", title: "Knowledge Quality Audit", tag: "Audit", tagColor: "#0f766e", desc: "סריקה סטטית — כפילויות, הפניות יתומות, קישורים שבורים, לוח איכות." },
    { href: "/verification/", he: "לוח אימות מאגר", title: "Verification Dashboard", tag: "Audit", tagColor: "#0f766e", desc: "סיווג כל ישות Verified/Partially/Needs + קישורים מומצאים, מיפויים חלשים, כפילויות ומיפויי FM/BAdI חשודים." },
    { href: "/import/", he: "מנוע ייבוא SAP", title: "SAP Import Engine", tag: "Arch", tagColor: "#0e7490", desc: "חבילת חילוץ (TSTC/TSTCT/DD02L/DD03L/TADIR/SE93) + מנוע ייבוא/אימות. ארכיטקטורה בלבד, ללא חיבור." },
    { href: "/cbc-model/", he: "מודל תחום CBC", title: "CBC Domain Model", tag: "CBC", tagColor: "#d62027", desc: "אזורי מפעל (קו ייצור/תרכיז/CIP/אצוות/אריזה/איכות/מחסן) → מודולי SAP (PP/PP-PI/QM/PM/MM) + אובייקטים, תהליכים ותקלות." },
