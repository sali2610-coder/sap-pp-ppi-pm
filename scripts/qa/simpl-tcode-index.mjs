// Which transaction codes (or, with FAMILY=tables|functions, which tables or
// function modules) each official SAP S/4HANA Simplification Item NAMES.
...
//   FAMILY=tables node scripts/qa/simpl-tcode-index.mjs
...
out.family = FAMILY;
writeFileSync(FAMILY === "transactions" ? "audit/master-completion/simpl-tcode-index.json" : `audit/master-completion/simpl-${FAMILY}-index.json`, JSON.stringify(out, null, 1));
