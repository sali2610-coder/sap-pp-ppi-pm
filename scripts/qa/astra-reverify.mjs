...
const LAYOUTS = {
  ...
  "834x1112-light-tablet": { VW: 834, VH: 1112, UA: "tablet" },
...
const ROWS = {
  ...
  "S10-2": { scripts: ["ux-measure.390x844-light-phone", "ux-measure.834x1112-light-tablet"], test: () => { const res = uxm("390x844-light-phone"); const o = ovText(res), e = errText(res); const t = layoutClean("834x1112-light-tablet"); return [o.ok && e.ok && !!t?.ok, `390×844 iPhone UA: ${o.text}; ${e.text}; 834×1112 iPad UA: ${t?.text ?? "not run"}`]; } },
