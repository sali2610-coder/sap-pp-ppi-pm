...
import { TX_VERIFICATION_D } from "@/data/verification/transactions-d";
import { TX_VERIFICATION_E } from "@/data/verification/transactions-e";
...
const all = [...TABLE_VERIFICATION, ...TX_VERIFICATION, ...TX_VERIFICATION_B, ...TX_VERIFICATION_C, ...TX_VERIFICATION_D, ...TX_VERIFICATION_E, ...TX_VERIFICATION_AUTO.filter((r) => ![...TX_VERIFICATION, ...TX_VERIFICATION_B, ...TX_VERIFICATION_C, ...TX_VERIFICATION_D, ...TX_VERIFICATION_E].some((x) => x.id === r.id)), ...FM_VERIFICATION, ...CDS_VERIFICATION, ...FIORI_VERIFICATION, ...ENH_VERIFICATION, ...IDOC_VERIFICATION] as any[];
