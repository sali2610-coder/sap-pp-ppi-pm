...
const all = [...TABLE_VERIFICATION, ...TX_VERIFICATION, ...TX_VERIFICATION_B, ...TX_VERIFICATION_AUTO.filter((r) => ![...TX_VERIFICATION, ...TX_VERIFICATION_B].some((x) => x.id === r.id)), ...FM_VERIFICATION, ...CDS_VERIFICATION, ...FIORI_VERIFICATION, ...ENH_VERIFICATION, ...IDOC_VERIFICATION] as any[];
