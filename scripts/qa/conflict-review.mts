...
const all = [...TABLE_VERIFICATION, ...TX_VERIFICATION, ...TX_VERIFICATION_B, ...FM_VERIFICATION, ...CDS_VERIFICATION, ...FIORI_VERIFICATION, ...ENH_VERIFICATION, ...IDOC_VERIFICATION] as any[];
