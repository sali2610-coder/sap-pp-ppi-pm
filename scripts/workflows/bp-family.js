...
READ FIRST and ONLY: audit/s4-enrichment/HOUSE-RULES.md (evidence shapes, validation rules, honesty rules, the scripted official channels: scripts/sap-help-search.mjs, scripts/sap-help-body.mjs, scripts/fal-app.mjs), then scratchpad/BP-PROCESS-BRIEF.md (the process-record shape and Hebrew style) and the exemplar record maintenance-notification-process in data/best-practices/pm-processes.ts. lib/evidence/types.ts (BestPracticeLike, BpProcessProfile incl. the "interfaces" lines) only if the brief leaves a field unclear.
