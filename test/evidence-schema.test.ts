...
const BPS = [...PM_BEST_PRACTICES, ...PPPI_BEST_PRACTICES, ...PM_PROCESS_PRACTICES, ...PP_PROCESS_PRACTICES];
const ALL_RECORDS = [
...
const DATA_FILES = [
  ...
  "data/best-practices/pm.ts", "data/best-practices/pp-pi.ts", "data/best-practices/pm-processes.ts", "data/best-practices/pp-processes.ts",
];
