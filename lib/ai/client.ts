...
const MSG = {
  ...
  timeout: "התשובה נמשכת זמן רב מהרגיל. השיחה נשמרה; אפשר לצמצם את ההיקף לפרק או לסעיף מסוים, או לנסות שוב.",
  offline: "אין חיבור לרשת. התשובות דורשות חיבור פעיל; שאר הפלטפורמה זמינה גם ללא רשת.",
  generic: "אירעה שגיאה זמנית. השיחה נשמרה; אפשר לנסות שוב בעוד רגע.",
  empty: "לא התקבלה תשובה. אפשר לנסח את השאלה מחדש ולשלוח שוב.",
};
