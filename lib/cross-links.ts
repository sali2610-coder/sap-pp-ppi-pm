...
export const OIC_OBJECTS: OICObject[] = [
  ...
  { slug: "maintenance-plan", table: "MPLA", he: "תכנית אחזקה", title: "Maintenance Plan", module: "PM", description: "מנהלת אחזקה מונעת מתוזמנת — אסטרטגיה, פריטים (MPOS), תזמון (MHIS) וקריאות אוטומטיות לפקודות/הודעות.", cbc: "ב-CBC: תכנית רבעונית למערכת מים מטוהרים + תכנית מבוססת-שעות למשאבות; IP30 יוצר פקודות במועד." },
  { slug: "measuring-point", table: "IMPTT", he: "נקודת מדידה", title: "Measuring Point", module: "PM", description: "מתעדת מצב ציוד (טמפ'/לחץ/שעות) — קריאות (IMRG) מזינות אחזקה מבוססת-מצב ותכניות מבוססות-ביצועים.", cbc: "ב-CBC: נקודת מונה שעות-פעולה על משאבת CIP; כל 2000 שעות נוצרת פקודת אחזקה מונעת." },
  { slug: "production-version", table: "MKAL", he: "גרסת ייצור", title: "Production Version", module: "PP-PI", description: "מקשרת BOM + מסלול/מתכון לשילוב ייצור תקף; חובה ב-S/4 ל-MRP Live/PP-DS.", cbc: "ב-CBC: גרסת 'קו 1' מקשרת BOM משקה + מתכון לקו מילוי 1 לטווח כמויות 10K-100K." },
  { slug: "routing", table: "PLPO", he: "פעולות מסלול/מתכון", title: "Routing / Recipe Operations", module: "PP-PI", description: "פעולות ושלבים (Phases) עם מרכזי עבודה/משאבים, זמנים והוראות תהליך (PI) — בסיס לתזמון, עלות ומרשם בקרה.", cbc: "ב-CBC: שלבי מתכון משקה — ערבוב→פסטור→מילוי→סגירה; הוראות תהליך נשלחות ל-MES." },
  { slug: "confirmation", table: "AFRU", he: "אישור ייצור/אחזקה", title: "Confirmation", module: "PP-PI", description: "רשומת דיווח ביצוע — שעות, כמויות, Backflush; מעדכנת עלות בפועל, מלאי וזמינות.", cbc: "ב-CBC: אישור שלב מילוי — 49,500 תקין + 500 פסולת; Backflush תרכיז + GR לאצווה." },
  { slug: "inspection-lot", table: "QALS", he: "מנת בדיקה (QM)", title: "Inspection Lot", module: "QM", description: "ישות הבדיקה של QM — נוצרת ב-GR/ייצור, נושאת תוצאות (QAMR) והחלטת שימוש (UD); חוסמת/משחררת מלאי.", cbc: "ב-CBC: GR לתרכיז יוצר מנת בדיקה; QA רושם Brix/pH ומחליט שימוש — חריגה חוסמת אצווה." },
];
