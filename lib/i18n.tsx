...
const DICT: Dict = {
  ...
  "search.recent": { he: "חיפושים אחרונים", en: "Recent searches" },
  "search.recent.clear": { he: "נקה", en: "Clear" },
  "search.suggested": { he: "הצעות מהירות", en: "Suggested" },
  "search.jump": { he: "מעבר מהיר", en: "Jump to" },
  "search.pages": { he: "עמודים", en: "Pages" },
  "search.scope.all": { he: "הכל", en: "All" },
