...
| **enterprise-ux-reviewer** | flow/IA/navigation change; "review UX", "too many clicks", "is this discoverable", "onboarding" | UX through **10 personas** (SAP Consultant, Implementer, Functional Analyst, QA Tester, Factory Manager, Production Planner, Maintenance Engineer, Executive, New Employee, First-time Visitor): navigation, IA, search discoverability, click-count, workflow, labels/terminology, breadcrumbs, empty/error/loading states, hierarchy, cognitive load, task completion | Owns persona UX critique + PASS/FAIL UX verdict. Defers final merge → enterprise-ux-auditor; geometry → adaptive-ui. |
