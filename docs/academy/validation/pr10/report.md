...
| home | m | 304→200 | 0→0 | 0→0 | same | same | ✅ identical |
| dashboard | d | 200→200 | 0→0 | 0→0 | same | same | ✅ identical |
| dashboard | m | 304→200 | 0→0 | 0→0 | same | same | ✅ identical |
| library | d | 200→200 | 0→0 | 0→0 | same | same | ✅ identical |
| library | m | 304→200 | 0→0 | 0→0 | same | same | ✅ identical |
| pm-academy | d | 200→200 | 0→0 | 0→0 | same | same | ✅ identical |
| pm-academy | m | 304→200 | 0→0 | 0→0 | same | same | ✅ identical |
| pppi-academy | d | 200→200 | 0→0 | 0→0 | same | same | ✅ identical |
| pppi-academy | m | 304→200 | 0→0 | 0→0 | same | same | ✅ identical |
