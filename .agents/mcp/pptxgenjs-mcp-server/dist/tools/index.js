export const toolDefinitions = [
    {
        ...
        description: "Create a new PowerPoint presentation. Returns a presentation ID that should be used for all subsequent operations.",
        inputSchema: {
            type: "object",
            properties: {
                id: {
    ...
    {
        name: "add_slide",
        description: "Add a new slide to an existing presentation. Returns the slide number.",
        inputSchema: {
            type: "object",
            properties: {
                presentationId: {
    ...
    {
        name: "add_text",
        description: "Add text to a slide with various formatting options.",
        inputSchema: {
            type: "object",
            properties: {
                presentationId: {
    ...
    {
        name: "add_shape",
        description: "Add a shape to a slide (rectangle, circle, triangle, etc.)",
        inputSchema: {
            type: "object",
            properties: {
                presentationId: {
    ...
    {
        name: "add_image",
        description: "Add an image to a slide from a file path or URL.",
        inputSchema: {
            type: "object",
            properties: {
                presentationId: {
    ...
    {
        name: "add_table",
        description: "Add a table to a slide with rows and columns of data.",
        inputSchema: {
            type: "object",
            properties: {
                presentationId: {
    ...
    {
        name: "add_chart",
        description: "Add a chart (bar, line, pie, etc.) to a slide with data.",
        inputSchema: {
            type: "object",
            properties: {
                presentationId: {
    ...
    },
    {
        ...
        description: "Save the presentation to a file. Returns the full path where the file was saved.",
        inputSchema: {
            type: "object",
            properties: {
                presentationId: {
    ...
    },
    {
        ...
        description: "List all active presentations in memory with their IDs and metadata.",
        inputSchema: {
            type: "object",
            properties: {},
        },
    },
    {
        ...
        description: "Delete a presentation from memory.",
        inputSchema: {
            type: "object",
            properties: {
                presentationId: {
