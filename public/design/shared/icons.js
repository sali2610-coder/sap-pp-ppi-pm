// Inline lucide-react path data — offline, no icon CDN, no emoji-as-icon.
// Stroke geometry matches lucide defaults (24x24, round caps/joins).
export const ICONS = {
  search:      '<circle cx="11" cy="11" r="8"/><path d="m21 21-4.3-4.3"/>',
  sparkles:    '<path d="M9.9 2.6 8.5 6.5 4.6 7.9l3.9 1.4 1.4 3.9 1.4-3.9 3.9-1.4-3.9-1.4z"/><path d="M18 8.5 17.2 10.7 15 11.5l2.2.8.8 2.2.8-2.2 2.2-.8-2.2-.8z"/><path d="M15.5 17 14.9 18.6 13.3 19.2l1.6.6.6 1.6.6-1.6 1.6-.6-1.6-.6z"/>',
  ...
  cable:       '<path d="M4 9a2 2 0 0 1-2-2V5h6v2a2 2 0 0 1-2 2Z"/><path d="M3 5V3"/><path d="M7 5V3"/><path d="M19 15V6.5a3.5 3.5 0 0 0-7 0v11a3.5 3.5 0 0 1-7 0V9"/><path d="M17 21v-2"/><path d="M21 21v-2"/><path d="M22 19h-6v-2a2 2 0 0 1 2-2h2a2 2 0 0 1 2 2Z"/>',
