    ...
    <AnimatePresence>
      {show && (
        <motion.div
          ...
          dir="rtl"
          className="no-print fixed inset-x-0 bottom-[10rem] z-[55] mx-auto flex max-w-sm items-center gap-3 rounded-2xl border border-hairline bg-ink-1/95 px-4 py-3 text-surface shadow-2xl backdrop-blur-md xl:hidden"
