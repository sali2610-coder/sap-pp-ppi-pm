...
export function OmniSearch() {
  ...
  return (
    <button
      ...
      className="group flex h-10 w-full max-w-md items-center gap-2.5 rounded-xl border border-white/25 bg-white/15 px-3.5 text-start text-brand-foreground/90 shadow-sm backdrop-blur-md transition-colors hover:bg-white/25"
      aria-label="פתח חיפוש מהיר"
    >
      <Search className="size-4 shrink-0 opacity-80" />
      <span className="flex-1 text-sm opacity-80">חיפוש טבלה, T-Code, BAPI…</span>
