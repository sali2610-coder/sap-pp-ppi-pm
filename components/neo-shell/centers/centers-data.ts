...
export const CENTER_FAMILIES: CenterFamily[] = [
  ...
  { id: "manufacturing", he: "תרחישי ייצור", en: "Manufacturing Scenarios",
    lede: "תרחישי ייצור מלאים: משקה, תרכיז, אצוות, CIP, אריזה ומחזורי הזמנת תהליך.", items: MFG_SCENARIOS },
  { id: "process-auth", he: "הרשאות לתהליכים", en: "Process Authorizations",
    lede: "אובייקטי הרשאה לכל תהליך PM ו-PP-PI, כשלים נפוצים ונתיב אבחון מ-SU53 עד PFCG.", items: PROCESS_AUTH },
  ...
  { id: "fiori", he: "יישומי Fiori לפי תהליך", en: "Fiori in Process",
    lede: "יישומי Fiori לפי התהליך העסקי שהם משרתים.", items: FIORI_CENTER },
