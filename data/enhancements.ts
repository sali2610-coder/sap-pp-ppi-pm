...
export const ENHANCEMENTS: Enhancement[] = [
  ...
  { slug: "customer-exit", title: "Customer Exit", he: "Customer Exit", kind: "Exit",
    ...
    note: "ניהול: SMOD מגדיר את ההרחבה (Enhancement), CMOD מנהל פרויקט שמפעיל ומקשר מימושים; המסגרת עצמה אינה נקודת הרחבה — היא מפעילה את ה-EXIT_ FMs. דיבוג: CMOD → Components → הפעלה; ללא פרויקט פעיל ה-EXIT לא רץ. דוגמה: פרויקט CMOD יחיד המרכז את כל ה-Customer Exits של תהליך האחזקה בארגון. S/4HANA: נתמך (GUI); Clean Core מעדיף BAdI/Enhancement Spot על Customer Exits. QA במיגרציה: ודא פרויקט CMOD פעיל לאחר המרה." },
  ...
  { slug: "implicit-enhancement", title: "Implicit Enhancement", he: "הרחבה משתמעת", kind: "Framework",
    ...
    note: "Implicit enhancements שבירים בשדרוג — תעד היטב. הנקודות נמצאות בתחילת/סוף יחידת הקוד הסטנדרטית (FM/method/subroutine) ללא הכנה מצד SAP; המימוש: Enhancement Implementation (ADT/SE80). דיבוג: ADT/SE80 → Enhancement; breakpoint בקוד ההרחבה. S/4HANA: נתמך; העדף נקודות מפורשות/BAdI. QA במיגרציה: ודא שההרחבה המשתמעת שורדת שדרוג." },
