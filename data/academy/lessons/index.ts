...
// Single lesson registry — pilot + pipeline-authored PM + PP-PI + QM lessons.
...
export const ALL_LESSONS: Record<string, Lesson> = { ...PILOT_LESSONS, ...PM_GENERATED_LESSONS, ...PP_GENERATED_LESSONS, ...QM_GENERATED_LESSONS };
