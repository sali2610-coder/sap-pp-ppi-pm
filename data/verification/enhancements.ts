/* Project NEO · verification overlay — enhancements (`enh:badi:` / `enh:exit:`
   ...
   Batch 9 (written 2026-09-25, access-stamped 2026-09-24, const DATE24): four audited deepenings of
   existing PP records. PPCO0007 is the auditor's fixedRecord; PPCO0021 is a minimal in-place edit
   (lastVerifiedAt and one appended re-check sentence); CONFPP01 is the draft with the verdict
   downgrades applied; CONFPP05 is the draft the auditor passed as is. The Public Cloud Extensibility
   page (loio 533228e1e854433ab16d013f161ca509, 2608.500) joins PPCO0007 as an official row bounded to
   the body text read, CONFPP05 as a supported_secondary_source background row next to the What's New
   2208 'OData API: Production Order Confirmation' row, and CONFPP01 as a verification_required
   snippet row. No status token, successor or repository row changed; PPCO0007 gains the xref
   enh:exit:IWO10012; rows not re-read keep their original DATE. Writer deviations (absence statements
   bounded to the text read, "not found" in place of "there is none") are listed in the queue file.
   enh:exit:PPCO0001 was refuted at the gate and is queued, not written.
   Batch 10 (written 2026-09-25, access-stamped 2026-09-24, const DATE24): five audited deepenings of
   existing records (WORKORDER_CONFIRM, PCSD0002, SAPLV01Z, MBCF0002, MB_MIGO_BADI), each the audited
   draft with the verdict downgrades applied (no verdict carried a fixedRecord). WORKORDER_CONFIRM gains
   three SAP S/4HANA Cloud Public Edition rows on BD_WORKORDER_CONFIRM (What's New 2302 and two 2608.500
   pages whose bodies were read) and the What's New 2023 URL the current search record prints. PCSD0002
   gains the What's New 2408.1 row on BOM_BEFORE_UPDATE and the xref enh:technique:key-user-extensibility;
   its 2026-09-21 notes are kept and the re-check is appended. SAPLV01Z gains two Public Cloud rows
   (2608.500 bodies read). MBCF0002 gains two What's New rows (LE_SHP_SPE_GM_CREATE,
   BD_WORKORDER_GOODSMOVT_BKF_GDR) and an authored verification_required status in place of the
...
export const ENH_VERIFICATION: VerificationRecord[] = [
  ...
  },
  {
    ...
    evidence: [
      ...
      },
      {
        ...
        edition: "on-premise",
        release: "2023.000",
        url: "https://help.sap.com/docs/SAP_S4HANA_ON-PREMISE/f296651f454c4284ade361292c633d69/da357e700f8c4592b25a317c0d171cb8.html?locale=en-US&state=PRODUCTION&version=2023.000",
        accessedAt: DATE24,
        claim: "פריט What's New לגרסת SAP S/4HANA 2023 On-Premise (Manufacturing > Production Operations > Production Execution) קובע: 'The new Business Add-In (BAdI) Checks for Confirmations (BD_WORKORDER_CONFIRM) enables you to implement own checks for confirmations and display respective error messages'. הרשומה נוקבת ב-BAdI חדש בשם BD_WORKORDER_CONFIRM ואינה מזכירה את ה-BAdI הקלאסי WORKORDER_CONFIRM. ראיה עקיפה: המקור עוסק ב-BAdI אחר (BD_WORKORDER_CONFIRM); חסר מקור רשמי הקושר אותו ל-WORKORDER_CONFIRM הקלאסי או הנוקב בזמינות ה-BAdI הקלאסי ב-S/4HANA.",
        verificationLevel: "verification_required",
      },
      {
        sourceType: "sap_help",
        ...
        accessedAt: DATE24,
        claim: "רשימת האובייקטים ששוחררו ל-Developer Extensibility ב-SAP S/4HANA 2023 On-Premise מונה: 'BAdI Check for Confirmations BD_WORKORDER_CONFIRM New You can use this BAdI to implement own checks for confirmations and display respective error messages that can be up to 200 characters long'. הכותרת מגדירה אותו כאובייקט משוחרר (released); הסניפט אינו מפרט מתודות, פרמטרים או Enhancement Spot. ראיה עקיפה: המקור עוסק ב-BAdI אחר (BD_WORKORDER_CONFIRM); חסר מקור רשמי הקושר אותו ל-WORKORDER_CONFIRM הקלאסי או הנוקב בזמינות ה-BAdI הקלאסי ב-S/4HANA.",
        verificationLevel: "verification_required",
      },
      {
        sourceType: "sap_help",
        sourceTitle: "BAdI for Checking Confirmations | What's New in SAP S/4HANA Cloud 2302",
        product: "SAP S/4HANA Cloud Public Edition",
        edition: "public-cloud",
        release: "2302.500",
        url: "https://help.sap.com/docs/SAP_S4HANA_CLOUD/ee9ee0ca4c3942068ea584d2f929b5b1/d0ff2dea431c457e8c47f08cd7ce4164.html?locale=en-US&state=PRODUCTION&version=2302.500",
        accessedAt: DATE24,
        claim: "פריט What's New לגרסת SAP S/4HANA Cloud 2302 (Public Edition, loio d0ff2dea431c457e8c47f08cd7ce4164) מתעד באותו ניסוח כמו פריט 2023 On-Premise: 'The new Business Add-In (BAdI) Checks for Confirmations (BD_WORKORDER_CONFIRM) enables you to implement own checks for confirmations and display respective error messages'. הסניפט אינו מזכיר את ה-BAdI הקלאסי WORKORDER_CONFIRM ואינו קובע יחס בין השניים. ראיה עקיפה: המקור עוסק ב-BAdI אחר.",
        verificationLevel: "verification_required",
      },
      {
        sourceType: "sap_help",
        sourceTitle: "Business Add-Ins (BAdIs) for Key User Extensibility | Production Planning and Control",
        product: "SAP S/4HANA Cloud Public Edition",
        edition: "public-cloud",
        release: "2608.500",
        url: "https://help.sap.com/docs/SAP_S4HANA_CLOUD/2bba750d1e124e1ea2a039bb1cd9b6c5/c20b8cfa8000468d86a005ec6d03259f.html?locale=en-US&state=PRODUCTION&version=2608.500",
        accessedAt: DATE24,
        claim: "גוף העמוד נקרא (sap-help-body.mjs, loio c20b8cfa8000468d86a005ec6d03259f). העמוד מונה את ה-BAdIs שעבורם ניתן לממש Custom Logic באפליקציית Custom Logic, ובהם 'Checks for Confirmations ( BD_WORKORDER_CONFIRM )' בהקשר העסקי Manufacturing: Order Confirmation (PP_ORDER_CONFIRMATION): 'You can use this BAdI to implement own checks for confirmations and display respective error messages that can be up to 200 characters long'. באותו הקשר עסקי העמוד מונה גם את 'Batch Determination in Order Confirmation ( BD_CONF_BATCH_DETERMINATION )' ואת 'Change of Goods Movement Data ( BD_WORKORDER_GOODSMOVT_BKF_GDR )', להשפעה על נתוני תנועות הסחורה בעת אישור פקודת ייצור או פקודת תהליך. העמוד אינו מזכיר את ה-BAdI הקלאסי WORKORDER_CONFIRM. ראיה עקיפה: המקור עוסק ב-BAdI אחר.",
        verificationLevel: "verification_required",
      },
      {
        sourceType: "sap_help",
        sourceTitle: "App Extensibility: Confirm Production Order Operation (CO11N) (Key User)",
        product: "SAP S/4HANA Cloud Public Edition",
        edition: "public-cloud",
        release: "2608.500",
        url: "https://help.sap.com/docs/SAP_S4HANA_CLOUD/2bba750d1e124e1ea2a039bb1cd9b6c5/dd313229871540368053d17eacf1e2ea.html?locale=en-US&state=PRODUCTION&version=2608.500",
        accessedAt: DATE24,
        claim: "גוף העמוד נקרא (sap-help-body.mjs). בטבלת ה-Custom Logic של אפליקציית CO11N ב-Public Cloud מופיע BAdI בתיאור 'Change of Goods Movement Data' בהקשר העסקי Manufacturing: Order Confirmation (PP_ORDER_CONFIRMATION), להשפעה על נתוני תנועות הסחורה בעת אישור פקודת ייצור. העמוד אינו נוקב בשם טכני ל-BAdI זה ואינו מזכיר את BD_WORKORDER_CONFIRM או את WORKORDER_CONFIRM.",
        verificationLevel: "verification_required",
      },
    ],
    xrefs: [
    ...
    lastVerifiedAt: DATE24,
    notes: "חיפושים בסבב 2026-09-24 בשירות החיפוש של SAP Help: 'BD_WORKORDER_CONFIRM' ב-SAP_S4HANA_ON-PREMISE (7 רשומות, שתיים נוקבות בשם: שני פריטי What's New 2023) וב-SAP_S4HANA_CLOUD (6 רשומות, ארבע נוקבות בשם: שני פריטי What's New Cloud 2302, ובגרסה 2608.500 העמודים 'Business Add-Ins (BAdIs) for Key User Extensibility' ו-'Developer Extensibility' של Production Planning and Control); 'WORKORDER_CONFIRM BAdI' (SAP_S4HANA_ON-PREMISE, 21 רשומות; SAP_S4HANA_CLOUD, 21 רשומות) לא העלה רשומה הנוקבת ב-BAdI הקלאסי. חיפושים קודמים: WORKORDER_CONFIRM, IF_EX_WORKORDER_CONFIRM, BAdI confirmation production order, BAdI maintenance order confirmation, Business Add-Ins confirmation PP-SFC. ה-BAdI הקלאסי WORKORDER_CONFIRM לא אותר באף רשומה של SAP S/4HANA (On-Premise או Public Cloud) בחיפושים אלה; זהו ממצא שלילי מתועד ולא קביעה על אי-קיום. הימצאותו ב-S/4HANA נשענת על רובד המאגר (data/exits.ts) ועל הערות השחרור של R/3 Enterprise 4.70, ולכן לא נקבע status. התיעוד של S/4HANA נוקב ב-BAdI אחר, BD_WORKORDER_CONFIRM: חדש ב-2023 On-Premise (What's New 2023.000, ברשימת האובייקטים המשוחררים ל-Developer Extensibility, בדיקות באישורים עם הודעות שגיאה עד 200 תווים) ומופיע באותו ניסוח ב-What's New של SAP S/4HANA Cloud 2302 (2302.500). לפי גוף העמוד 'Business Add-Ins (BAdIs) for Key User Extensibility' (Public Edition 2608.500), BD_WORKORDER_CONFIRM זמין ב-Custom Logic ב-Public Cloud בהקשר העסקי PP_ORDER_CONFIRMATION. עמוד ה-App Extensibility של CO11N (Key User, 2608.500) אינו מזכיר אותו: טבלת ה-Custom Logic שלו מציגה BAdI בתיאור 'Change of Goods Movement Data' ללא שם טכני. עמוד זה מתאר את אפליקציית CO11N ואינו רשימה כללית של BAdIs לאישורים ב-Public Cloud. היחס בין BD_WORKORDER_CONFIRM לבין ה-BAdI הקלאסי (מחליף, משלים או מקביל) אינו נאמר באף מקור שנקרא, ו-BD_WORKORDER_CONFIRM אינו מזהה בדאטהסט, ולכן אינו xref ואינו successor. enh:badi:WORKORDER_GOODSMVT נשאר ב-xrefs לפי הקשר במאגר; אף מקור שנקרא אינו מזהה אותו עם 'Change of Goods Movement Data' או עם BD_WORKORDER_GOODSMOVT_BKF_GDR. תיעוד ECC לתעשיות תהליכיות (Insertion of Customer-Specific Fields, SAP ERP 6.0 EHP7, loio 3a00b753128eb44ce10000000a174cb4) נוקב ב-BAdI אחר, WORKORDER_CONFIRM_CUST_SUBSCR, לעיצוב ה-subscreen של שדות לקוח באישור; אותו עמוד קיים ב-S/4HANA 2025 FPS01 (Production Planning and Control) אך הסניפט שלו אינו נוקב בשם ה-BAdI. המתודות 'BEFORE/AFTER confirmation', ממשק IF_EX_WORKORDER_CONFIRM והשיוך לאישורי תחזוקת מפעל (IW41/IW42) נשארים ברובד המאגר ולא אומתו מול מקור רשמי שנקרא; הערות השחרור מתעדות מתודה בשם BEFORE_UPDATE ותחולה על 'production and process orders'. תיקון URL: שורת What's New 2023 'BAdI for Checking Confirmations' (loio da357e700f8c4592b25a317c0d171cb8) הצביעה על deliverable f5d3e1005efd4e86acf9a65abf428082; רשומת החיפוש הנוכחית מדפיסה לאותו loio את f296651f454c4284ade361292c633d69, וה-URL הועתק ממנה. Old → New (2026-09-24): בגרסה הקודמת נכתב שהסטטוס ב-S/4HANA נגזר מבלוק ה-ECC מול S/4HANA ברשומת המאגר ('מועדף על CONFPP exits') ולא נקבע ידנית; גם כעת לא נכתב authored status; בלוק המאגר מתועד בשורת ה-repository, וכל סטטוס מוצג נגזר ממנו ולא ממקור רשמי. בגרסה הקודמת נכתב שגוף העמודים ב-help.sap.com לא נקרא (מעטפת JavaScript) ושרק ה-PDF של הערות השחרור נקרא במלואו; בסבב זה נקראו דרך שירות התוכן (sap-help-body.mjs) גופי שני עמודי Public Cloud (רשימת ה-BAdIs ל-Key User ועמוד ה-App Extensibility של CO11N), ושאר עמודי help.sap.com ברשומה מצוטטים מסניפטים של שירות החיפוש. בגרסה הקודמת החיפושים נגעו ל-S/4HANA On-Premise; בסבב זה נוסף היקף SAP_S4HANA_CLOUD. לא בוצעה בדיקה במערכת SAP חיה.",
  },
  {
  ...
  },
  {
    ...
    evidence: [
      ...
      },
      {
        ...
        release: "2608.500",
        accessedAt: DATE24,
        claim: "טקסט גוף העמוד 'Extensibility' של SAP S/4HANA Cloud Public Edition ‏(2608 Latest, loio 533228e1e854433ab16d013f161ca509) נקרא דרך scripts/sap-help-body.mjs (התרשים האינטראקטיבי שבעמוד לא נקרא). לפי העמוד ('consists of the following options'), ההרחבה ב-Public Cloud כוללת שלוש אפשרויות: Key User Extensibility, Developer Extensibility ו-Side-by-Side Extensibility. בטבלת ההשוואה, 'Released object types' של Key User Extensibility הם BAdIs ו-CDS views, ושל Developer Extensibility הם BAdIs, classes, interfaces, CDS views, behavior definitions ו-authorization objects. טקסט הגוף שנקרא אינו מזכיר Customer Exits קלאסיים (SMOD/CMOD, Function Exit), את PPCO0007 או את EXIT_SAPLCOZV_001, ואינו קובע מפורשות שהטכניקה הקלאסית אינה זמינה ב-Public Cloud. זו עדות כללית על מסגרת ההרחבה; היעדר האזכור הוא ממצא תחום ולא הצהרת אי-זמינות. אותו עמוד נרשם גם ברשומות enh:technique:customer-exit ו-enh:exit:IWO10012.",
        verificationLevel: "sap_official_verified",
      },
      {
        sourceType: "repository",
  ...
  },
  {
    ...
    status: {
      status: "unchanged",
      he: "לפי תיעוד ה-Workflow של SAP S/4HANA On-Premise 2025 FPS01 (תרחיש 'Confirmation Variances (PP-SFC)'), ההרחבה CONFPP05 עם ה-Function Exit‏ EXIT_SAPLCORF_105 עדיין מתועדת כהרחבה שיש לתכנת ולהפעיל כדי להודיע למתכנן החומרים (MRP controller) על חריגות באישור הזמנת ייצור; ברשומות החיפוש שנבדקו לא נמצאה הערת פישוט, הסרה או החלפה. הסטטוס מתייחס לקיום ההרחבה ולתפקידה המתועד בלבד ב-SAP S/4HANA On-Premise, לא לתיאור 'תנועות מלאי באישור' שברשומת המאגר, שאינו נתמך במקורות שאותרו, ולא לזמינות ב-SAP S/4HANA Cloud Public Edition, שנותרה בלתי מאומתת (ראו notes).",
      edition: "on-premise",
      release: "2025.001",
      source: {
        sourceType: "sap_help",
    ...
    evidence: [
      ...
      },
      {
        ...
        release: "2608.500",
        accessedAt: DATE24,
        claim: "עמוד help.sap.com 'Extensibility' (deliverable: Extend and Integrate Your SAP S/4HANA Cloud Public Edition, SAP S/4HANA Cloud Public Edition 2608, loio 533228e1e854433ab16d013f161ca509), שגופו נקרא דרך sap-help-body.mjs ב-2026-09-24 (התרשים האינטראקטיבי שבעמוד לא נקרא), מונה שלוש אפשרויות Extensibility: Key User Extensibility, Developer Extensibility ו-Side-by-Side Extensibility, ומונה בין יתרונות אפשרויות ה-Extensibility את 'Custom ABAP development directly on SAP S/4HANA Cloud Public Edition stack' ו-'Use and extend released SAP S/4HANA Cloud Public Edition objects'. טקסט הגוף שנקרא אינו נוקב ב-Customer Exits, ב-SMOD, ב-CMOD או ב-CONFPP05. הרשומה נאספת כרקע כללי בלבד על אפשרויות ה-Extensibility ב-Public Edition, לא כקביעה לגבי CONFPP05.",
        verificationLevel: "supported_secondary_source",
      },
      {
        sourceType: "sap_help",
        sourceTitle: "OData API: Production Order Confirmation | What's New in SAP S/4HANA Cloud 2208",
        url: "https://help.sap.com/docs/SAP_S4HANA_CLOUD/ee9ee0ca4c3942068ea584d2f929b5b1/fd52cebecb9d450a9c9c9d540ca4f803.html?locale=en-US&state=PRODUCTION&version=2208.500",
        product: "SAP S/4HANA Cloud Public Edition",
        edition: "public-cloud",
        release: "2208.500",
        accessedAt: DATE24,
        claim: "רשומת החיפוש וגוף העמוד (נקרא דרך sap-help-body.mjs, 2026-09-24) קובעים: 'With the OData API Production Order Confirmation (API_PROD_ORDER_CONFIRMATION_2_SRV), you can process confirmations for production orders' (SAP S/4HANA Cloud 2208, Application Component PP-SFC-ES). הרשומה אינה נוקבת ב-CONFPP05 או ב-EXIT_SAPLCORF_105, ואינה מתארת את ה-API כמחליף של ההרחבה; היא נאספת רק כחלופה מבוססת API לעיבוד אישורים ב-Public Cloud, לשימוש אם יידרש אימות נוסף.",
        verificationLevel: "supported_secondary_source",
      }
    ],
    xrefs: [
  ...
  },
  {
    ...
    status: {
      status: "verification_required",
      he: "המפתח SAPLV01Z שבקטלוג ההרחבות לא נמצא באף רשומת חיפוש רשמית של SAP Help כשם של הרחבת SMOD. רשומות החיפוש לגרסת SAP S/4HANA 2025 FPS01 (On-Premise) נוקבות בהרחבה SAPLV1ZN, שרכיב ה-Customer Exit הנקוב בה הוא EXIT_SAPLV01Z_014 (המחרוזת SAPLV01Z מופיעה בהן כחלק משם מודול הפונקציה). התיעוד מייעד את SAPLV1ZN להשפעה על סיווג האצווה בזמן קבלת טובין להזמנת ייצור ולהזמנת רכש ולאכלוס שדות אב האצווה; אף עמוד רשמי שאותר אינו מייחס לה קביעת אצווה (Batch Determination), שהיא התכלית שהקטלוג מתאר. בסבב 2026-09-24 חיפוש SAPLV1ZN בהיקף ברירת המחדל של כלי החיפוש (SAP_S4HANA_ON-PREMISE) החזיר 3 רשומות, כולן SAP S/4HANA On-Premise 2025.001; בשאילתות שהורצו בהיקף SAP_S4HANA_CLOUD (ראו notes) לא הוחזרה רשומה הנוקבת בהרחבה, ואי-מציאה זו אינה ראיה לאי-זמינות. ה-BAdI LOBM_BATCH_DET_QTY_PROPOSAL מופיע גם בעמוד Public Cloud 2608 Latest כ-BAdI ל-Custom Logic בהצעת כמות בקביעת אצווה; אף מקור שנקרא או צוטט ברשומה זו אינו קושר אותו ל-SAPLV1ZN, ותכליתו המתועדת (הצעת כמות בקביעת אצווה) שונה מהתפקיד המתועד של ההרחבה (סיווג אצווה ואכלוס אב האצווה בקבלת טובין). מאחר שהשם, התכלית, הטרנזקציות והיורש שברשומת הקטלוג אינם נתמכים בתיעוד, המעמד נשאר 'נדרש אימות נוסף' עד תיקון הקטלוג ובדיקת SMOD במערכת S/4HANA.",
      edition: "on-premise",
      release: null,
      source: null,
      recommendedAction: "לתקן את רשומת הקטלוג: מפתח SAPLV1ZN (שם ההרחבה כפי שהיא מתועדת) עם SAPLV01Z ו-EXIT_SAPLV01Z_014 ככינויים, תכלית 'אכלוס שדות אב האצווה וסיווג האצווה בקבלת טובין להזמנת ייצור ולהזמנת רכש', והסרת התיאור 'קביעת אצווה'. לאמת במערכת S/4HANA On-Premise חיה: SMOD (קיום ההרחבה SAPLV1ZN ורשימת רכיבי ה-EXIT שלה), CMOD (פרויקט פעיל), SE37 (מודול הפונקציה EXIT_SAPLV01Z_014). Private Cloud Edition: לא צוטט מקור נפרד. ב-Public Cloud לבחון את עמודי 2608 Latest שאותרו בשם ובסניפט בלבד: 'Extensibility for Characteristic Value Modification for Batch' (loio ff4093b764ac47d68561a94358273d5b; הסניפט: 'You can create or delete characteristic values for a classified batch in goods movement processes') ו-'App Extensibility: Post Goods Receipt for Purchasing Document' (loio df404e3e691f44eabd3fa2ee0412010d; הסניפט: 'As a key user, you can extend the Post Goods Receipt for Purchasing Document app'). גופם לא נקרא ואף מקור שנקרא אינו קובע שהם מחליפים את SAPLV1ZN. ללוגיקת בחירה בקביעת אצווה (FEFO, חסימת אצוות שנפסלו ב-QM) לבחון את ה-BAdI המתועד VB_BD_SELECTION (נמצא ברשומות On-Premise 2025.001). ה-BAdI LOBM_BATCH_DET_QTY_PROPOSAL מופיע ברשומת On-Premise 2025.001 וגם בעמוד Public Cloud 2608 Latest כ-BAdI שניתן לממש בו Custom Logic (Custom Logic app) בהצעת כמות בקביעת אצווה; אף מקור שנקרא או צוטט ברשומה זו אינו קושר אותו ל-SAPLV1ZN, ותכליתו המתועדת (הצעת כמות בקביעת אצווה) שונה מהתפקיד המתועד של ההרחבה (סיווג אצווה ואכלוס אב האצווה בקבלת טובין). לא לרשום יורש לפני שמקור רשמי קובע החלפה. לפיתוחי ECC קיימים: בדיקה ב-ATC ו-SCMON.",
    },
    evidence: [
      {
        sourceType: "sap_help",
      ...
      {
        sourceType: "sap_help",
        sourceTitle: "Extensibility for Quantity Proposal in Batch Determination | Supply Chain",
        url: "https://help.sap.com/docs/SAP_S4HANA_CLOUD/32da8359c8ee4e8b8e8c5e15cacba5aa/bade65d5ffd049249bbd22cc0c672898.html?locale=en-US&state=PRODUCTION&version=2608.500",
        product: "SAP S/4HANA Cloud Public Edition",
        edition: "public-cloud",
        release: "2608.500",
        accessedAt: DATE24,
        claim: "גוף העמוד (SAP S/4HANA Cloud Public Edition 2608 Latest, Deliverable 'Supply Chain', loio bade65d5ffd049249bbd22cc0c672898, אותו loio כמו ברשומת ה-On-Premise) נקרא דרך scripts/sap-help-body.mjs. הטקסט: 'You can extend the standard setting for the quantity proposal in batch determination. Features You can implement custom logic for the following Business Add-Ins (BAdIs): ... Procedures for Quantity Proposal ( LOBM_BATCH_DET_QTY_PROPOSAL ) SAP Business Accelerator Hub Batch Determination', וכן 'For more information check the BAdI-specific documentation in the Custom Logic app'. בקשר המידע הנוסף נזכרים 'Key User Extensibility' ו-'Custom Fields App and Custom Logic App'. לפי העמוד, LOBM_BATCH_DET_QTY_PROPOSAL מופיע כ-BAdI שניתן לממש בו Custom Logic (Custom Logic app) להצעת כמות בקביעת אצווה. העמוד אינו מזכיר את SAPLV1ZN, את EXIT_SAPLV01Z_014 או סיווג אצווה בקבלת טובין.",
        verificationLevel: "sap_official_verified",
      },
      {
        sourceType: "sap_help",
        sourceTitle: "Extensibility in Batch Management | Supply Chain",
        url: "https://help.sap.com/docs/SAP_S4HANA_CLOUD/32da8359c8ee4e8b8e8c5e15cacba5aa/2660601672564e6a869fd7dc20fffa1b.html?locale=en-US&state=PRODUCTION&version=2608.500",
        product: "SAP S/4HANA Cloud Public Edition",
        edition: "public-cloud",
        release: "2608.500",
        accessedAt: DATE24,
        claim: "גוף העמוד (SAP S/4HANA Cloud Public Edition 2608 Latest, loio 2660601672564e6a869fd7dc20fffa1b) נקרא דרך scripts/sap-help-body.mjs, והטקסט שהוחזר הוא כותרת ומשפט מבוא: 'This section describes the extensibility options key users have, for example, by adding additional fields to different apps'. הטקסט אינו נוקב ב-BAdI, ב-Customer Exit או בשם טכני, ואינו מזכיר את SAPLV1ZN, EXIT_SAPLV01Z_014, VB_BD_SELECTION או קביעת אצווה. הוא משמש כאן כפרק המבוא של הרחבת Batch Management ב-Public Cloud, ואינו ראיה לתכלית ההרחבה נושא הרשומה או לזמינותה.",
        verificationLevel: "sap_official_verified",
      },
      {
        sourceType: "repository",
    ...
    lastVerifiedAt: DATE24,
    notes: "סבב 2026-09-14 (שירות החיפוש, scripts/sap-help-search.mjs): ההרחבה מתועדת בשם SAPLV1ZN, עם רכיב ה-Exit EXIT_SAPLV01Z_014, בעמודי 2025 FPS01 (On-Premise) ובעמודי SAP ERP 6.0 EHP8 באותם loio: 'Alternative Units of Measure in Production' (10cec353b677b44ce10000000a174cb4), 'Prerequisites/Customizing' (a7fdb753128eb44ce10000000a174cb4, 'You can also fill batch master fields or the batch classification using the enhancement SAPLV1ZN') ו-'Documentary Batches (LO-BM)' (24ffb753128eb44ce10000000a174cb4). בשלושתם התפקיד הוא אכלוס שדות אב האצווה או סיווג האצווה בקבלת טובין; אף אחד מהם אינו מייחס להרחבה קביעת אצווה. חיפוש המחרוזת SAPLV01Z לבדה (S/4HANA On-Premise ו-SAP ERP) החזיר את העמודים הנוקבים ב-EXIT_SAPLV01Z_014; לא אותרה רשומת חיפוש המתארת SAPLV01Z כשם הרחבה, ואי-מציאה זו אינה ראיה לאי-קיום ההרחבה במערכת. עמוד 'Develop Enhancements' של ספריית SAP 4.6C (רשימת ההרחבות של PM/CS) נקרא במלואו ואינו כולל הרחבות אצווה. לקביעת אצווה עצמה התיעוד On-Premise נוקב בשני BAdI: VB_BD_SELECTION ('Business Add-Ins (BAdIs) for Batches', 8ffdb753128eb44ce10000000a174cb4, 2025.001) ו-LOBM_BATCH_DET_QTY_PROPOSAL להצעת כמות ('Extensibility for Quantity Proposal in Batch Determination', bade65d5ffd049249bbd22cc0c672898, 2025.001; אותו BAdI מוצג בשמו התיאורי ב-'BAdI for Quantity Proposal Procedures in Batch Determination', What's New in SAP S/4HANA 2021, 62512a20dd7641b396f5c7e72739c3a4). שני השמות לא אומתו ב-SE18 במערכת ואינם קיימים כרשומות במאגר, ולכן לא נרשם יורש ולא נוסף xref. השם VB_BD_BATCH_DETERMINATION, המופיע במאגר (troubleshooting, solutions, process-guides, centers/debugging, academy), לא נמצא באף רשומת SAP Help. הטרנזקציות CO11N, COR6N ו-VL02N שברשומת המאגר אינן נזכרות בסניפטים הרשמיים (המתארים קבלת טובין להזמנת ייצור ולהזמנת רכש), ונשמרות כ-xref בהקשר המאגר. בסבב 2026-09-14 גוף עמודי help.sap.com לא נקרא, וטענות אותו סבב תחומות בכותרת ובסניפט.\n\nסבב 2026-09-24 (הבחנה בין On-Premise ל-Public Cloud). שאילתות ותוצאות: 'SAPLV1ZN' (ללא --product, כלומר בהיקף ברירת המחדל של הכלי, SAP_S4HANA_ON-PREMISE): 3, כולן On-Premise 2025.001 (Prerequisites/Customizing, Alternative Units of Measure in Production, Documentary Batches (LO-BM)). 'VB_BD_SELECTION' (--product SAP_S4HANA_CLOUD): 2, לא רלוונטיות (Assign Warehouse Order, Operations for Warehouse API; APIs for Warehousing, 2602.500). 'Extensibility in Batch Management' (--product SAP_S4HANA_CLOUD): הכלי החזיר 21 רשומות, ביניהן 'Extensibility in Batch Management', 'Batch Management: FAQ', 'Batch Number Assignment' ו-'Extensibility for Adoption of Last Goods Receipt Date in Batch Replication' (Supply Chain, 2608.500); אף כותרת או סניפט אינם נוקבים ב-SAPLV1ZN או ב-EXIT_SAPLV01Z_014. 'batch determination extensibility key user' (--product SAP_S4HANA_CLOUD): הכלי החזיר 21 רשומות, ביניהן 'Extensibility for Quantity Proposal in Batch Determination' ו-'Extensibility for Batch Number Check' (Supply Chain, 2608.500); אף כותרת אינה נוקבת ב-SAPLV1ZN. 'customer exit SMOD CMOD not available S/4HANA Cloud Public Edition' (--product SAP_S4HANA_CLOUD): הכלי החזיר 21 רשומות, ואף כותרת אינה עוסקת ב-Customer Exit או בהרחבות אצווה. 'customer exit classic extensibility not available S/4HANA Cloud' (ללא --product, כלומר בהיקף ברירת המחדל SAP_S4HANA_ON-PREMISE): הכלי החזיר 21 רשומות (בעיקר What's New של SAP S/4HANA), ואף כותרת אינה נוקבת ב-SAPLV1ZN. שאילתות ישירות על כיווני בדיקה (--product SAP_S4HANA_CLOUD): 'Extensibility for Characteristic Value Modification for Batch' החזירה את העמוד בשם זה (Supply Chain, 2608.500, loio ff4093b764ac47d68561a94358273d5b), והסניפט שלו: 'You can create or delete characteristic values for a classified batch in goods movement processes'. 'App Extensibility: Post Goods Receipt for Purchasing Document' החזירה את העמוד בשם זה (Supply Chain, 2608.500, loio df404e3e691f44eabd3fa2ee0412010d), והסניפט שלו: 'As a key user, you can extend the Post Goods Receipt for Purchasing Document app'. גוף שני העמודים לא נקרא, ואף מקור שנקרא אינו קובע שהם מחליפים את SAPLV1ZN.\n\nגופי עמוד שנקראו (scripts/sap-help-body.mjs, Public Cloud 2608 Latest, versionId 2608.500): 'Extensibility for Quantity Proposal in Batch Determination' (loio bade65d5ffd049249bbd22cc0c672898): LOBM_BATCH_DET_QTY_PROPOSAL מופיע כ-BAdI שניתן לממש בו Custom Logic (Custom Logic app). אף מקור שנקרא או צוטט ברשומה זו אינו קושר אותו ל-SAPLV1ZN, ותכליתו המתועדת (הצעת כמות בקביעת אצווה) שונה מהתפקיד המתועד של ההרחבה (סיווג אצווה ואכלוס אב האצווה בקבלת טובין). 'Extensibility in Batch Management' (loio 2660601672564e6a869fd7dc20fffa1b): משפט מבוא כללי על אפשרויות הרחבה של key users, בלי שם טכני.\n\nמצב לפי Edition: On-Premise: SAPLV1ZN נמצאת ברשומות 2025.001 (3 רשומות). VB_BD_SELECTION נמצא ברשומות On-Premise 2025.001; לא הוחזרה רשומת Public Cloud הנוקבת בשמו (2 תוצאות לא רלוונטיות). Public Cloud: לא הוחזרה רשומת חיפוש Public Cloud הנוקבת ב-SAPLV1ZN או ב-EXIT_SAPLV01Z_014 (ברשימת השאילתות לעיל אין שאילתה על השם SAPLV1ZN עצמו בהיקף SAP_S4HANA_CLOUD). Private Cloud Edition: לא צוטט מקור נפרד. לגבי מסגרת ההרחבה הכללית ב-Public Cloud, ראו רשומת enh:exit:PPCO0007. אי-מציאה בחיפוש היא ממצא שלילי מתועד ולא קביעת אי-זמינות.\n\nנותר לאמת: רכיבי EXIT נוספים של SAPLV1ZN, הפרמטרים של EXIT_SAPLV01Z_014 ומעמד ההרחבה בקטלוג הפישוט, דרך SMOD/CMOD/SE37 במערכת S/4HANA On-Premise חיה או פריט פישוט חתום-גרסה (קטלוג הפישוט ו-SAP Notes חסומים בהתחברות S-user). ה-MCP של sc4sap לא התחבר במושב זה. לא בוצעה בדיקה במערכת SAP חיה. רשומת ה-CDS I_Batch (data/verification/cds.ts) מפנה ל-enh:exit:SAPLV01Z, ולכן מזהה הרשומה נשמר כ-SAPLV01Z ו-SAPLV1ZN נרשם ככינוי.",
  },
  {
    ...
    status: {
      status: "verification_required",
      he: "אף רשומת SAP Help או פריט פישוט שנבדקו (כולל חמש שאילתות חיפוש מ-2026-09-24) אינם נוקבים בשם ההרחבה MBCF0002 או במודול הפונקציה EXIT_SAPMM07M_001, ולכן לא נקבע מעמד S/4HANA רשמי ולא יורש. ה-BAdI MB_MIGO_BADI שברשומת המאגר לא הוחזר בכותרת או בסניפט של אף רשומה רשמית, וה-BAdI שאותרו בחיפוש, LE_SHP_SPE_GM_CREATE לשינוי נתונים בתעודת משלוח לפני רישום תנועת הסחורה ו-Change of Goods Movement Data (BD_WORKORDER_GOODSMOVT_BKF_GDR) המשפיע על הנתונים שיירשמו בתנועות סחורה, אינם מוצגים כיורשים של MBCF0002.",
      edition: "on-premise",
      release: null,
      source: null,
      recommendedAction: "לאמת ב-SMOD וב-CMOD במערכת S/4HANA חיה אם ההרחבה MBCF0002 ורכיב EXIT_SAPMM07M_001 עדיין נקראים בעת רישום תנועת סחורה ב-MIGO, ולבדוק במערכת אם ה-BAdI MB_MIGO_BADI שברשומת המאגר מממש ולידציה דומה; עד אז חסימת תנועות GI/GR המבוססת על ההרחבה נשארת תלוית אימות.",
    },
    evidence: [
      {
        sourceType: "sap_help",
      ...
      {
        sourceType: "sap_help",
        sourceTitle: "Extensibility for Goods Movements | What's New in SAP S/4HANA and SAP S/4HANA Cloud Private Edition 2025 FPS01",
        url: "https://help.sap.com/docs/SAP_S4HANA_ON-PREMISE/f5d3e1005efd4e86acf9a65abf428082/d4538b721f6d47d9a1fa076b82c1bf77.html?locale=en-US&state=PRODUCTION&version=2025.001",
        product: "SAP S/4HANA",
        edition: "on-premise",
        release: "2025.001",
        accessedAt: DATE24,
        claim: "רשומת What's New לגרסת 2025 FPS01 (loio d4538b721f6d47d9a1fa076b82c1bf77, אותרה בשאילתת 'Post Goods Movement extensibility BAdI' מ-2026-09-24) קובעת בסניפט: 'You can extend and change data in a delivery before goods movement is posted.' וכן 'For this, you can use Business Add-In Goods Movement Data Modification (LE_SHP_SPE_GM_CREATE).' כלומר BAdI המאפשר, לפי הסניפט, שינוי נתונים בתעודת משלוח (delivery) לפני רישום תנועת הסחורה. הרשומה אינה מזכירה את MBCF0002 או EXIT_SAPMM07M_001 ואינה מציגה יורש רשמי לה. גוף העמוד לא נקרא; הטענה תחומה בכותרת ובסניפט.",
        verificationLevel: "sap_official_verified",
      },
      {
        sourceType: "sap_help",
        sourceTitle: "BAdI for Change of Goods Movement Data | What's New in SAP S/4HANA 2022",
        url: "https://help.sap.com/docs/SAP_S4HANA_ON-PREMISE/e296651f454c4284ade361292c633d69/b2955f4446fc4c3cb76d7c1f7a22bf0e.html?locale=en-US&state=PRODUCTION&version=2022.000",
        product: "SAP S/4HANA",
        edition: "on-premise",
        release: "2022.000",
        accessedAt: DATE24,
        claim: "רשומת What's New לגרסת 2022 (loio b2955f4446fc4c3cb76d7c1f7a22bf0e, אותרה בשאילתת 'Post Goods Movement extensibility BAdI' מ-2026-09-24) קובעת בסניפט: 'The new Business Add-In (BAdI) Change of Goods Movement Data (BD_WORKORDER_GOODSMOVT_BKF_GDR) enables you to influence the data that will be posted for the goods'. הרשומה אינה מזכירה את MBCF0002 או EXIT_SAPMM07M_001 ואינה מציגה את ה-BAdI כיורש שלה. גוף העמוד לא נקרא; הטענה תחומה בכותרת ובסניפט.",
        verificationLevel: "sap_official_verified",
      },
    ],
    xrefs: [
  ...
  },
  {
    ...
    lastVerifiedAt: DATE24,
    notes: "שיטה (2026-09-14): שתים-עשרה שאילתות בשירות החיפוש הרשמי של SAP Help (scripts/sap-help-search.mjs; המוצרים SAP_S4HANA_ON-PREMISE, SAP_ERP ו-SUPPORT_CONTENT), ארבעה חיפושי רשת מוגבלים לדומיינים הרשמיים, ושלושה מסמכי PDF רשמיים מ-help.sap.com שהורדו ונקראו בקטעים הרלוונטיים (הערות השחרור המלאות של R/3 Enterprise 4.70, RN_470_EN; הערות השחרור MM ל-ECC 6.0, פרק 13; הערות השחרור Procurement and Logistics Execution ל-EHP4). מה שאומת רשמית: השם MB_MIGO_BADI, ייעודו (מסכי משנה חיצוניים ב-MIGO), מועד ההופעה (R/3 Enterprise Core 4.70, SAP_APPL 470) וצומת ה-IMG שלו; וכן, בנפרד, שהטרנזקציה MIGO מופיעה בתפקיד העסקי Goods Movement (MM-IM) בתיעוד S/4HANA 2025 FPS01 (loio 3b07b753128eb44ce10000000a174cb4, SAP_MM_IM_GOODS_MOVEMENTS). מה שלא נמצא: אף עמוד help.sap.com ל-S/4HANA (2023, 2025 FPS01, What's New, Simplification) המזכיר את MB_MIGO_BADI בכותרת או בסניפט; PDF ההערות של ECC 6.0 ו-EHP4 אינם מזכירים אותו. שם הממשק IF_EX_MB_MIGO_BADI ושמות המתודות אינם מופיעים באף מקור רשמי שנמצא ונשענים על קטלוג הפרויקט בלבד. עמוד Support Content אחד בדומיין help.sap.com (תוכן שמקורו בוויקי הקהילה, loio 3353523494) מונה בשורת אינדקס כותרת 'How to access to the attibuts of Class LCL_MIGO_KERNEL in Badi MB_MIGO_BADI'; הוא אינו מצוטט כראיה כי גוף העמוד אינו נגיש (מעטפת JavaScript) ומקורו קהילתי. ההצמדה 'Post Goods Movement (F0843)' ברשומת הקטלוג אינה מדויקת לפי רשומת ה-Fiori של הפרויקט: F0843 הוא Post Goods Receipt for Purchasing Document; ליישומי ה-Fiori לקבלת סחורה תיעוד App Extensibility משלהם (2025 FPS01, deliverable Inventory Management and Inventory) הנוקב ב-BAdIs נפרדים (MMIM_GR4XY_CHECK_DATA, BADI_MMIM_CHECK_MATDOC_ITEM) ולא ב-MB_MIGO_BADI. לא נמצא SAP Note או KBA בעמוד ציבורי רשמי; לא הוקלד מספר מהזיכרון. אין MCP חי, ולכן קיום ה-BAdI ורשימת המתודות ב-S/4HANA דורשים אימות ב-SE18 במערכת היעד. השלמת מחקר (2026-09-24, סבב Public Cloud): שלוש שאילתות בשירות החיפוש עם --product SAP_S4HANA_CLOUD. השאילתה 'MB_MIGO_BADI' החזירה 3 עד 4 תוצאות (המספר השתנה בין הרצות חוזרות), ואף אחת מהן אינה נוקבת ב-MB_MIGO_BADI בכותרת או בסניפט (בין היתר Configuring START_BORDER_CR_CODE, MaterialDocumentCreateNotification_Async_Out ורשומה על קובץ מצורף להסכם הובלה). השאילתה 'classical enhancement techniques BAdI customer exits not part of extensibility model public cloud' החזירה 21 תוצאות, והשאילתה 'classic enhancement techniques not released cloud extensibility' החזירה 21 תוצאות; באף אחת מהן MB_MIGO_BADI אינו נזכר בכותרת או בסניפט. עמוד 'Extensibility' (loio 533228e1e854433ab16d013f161ca509, Extend and Integrate Your SAP S/4HANA Cloud Public Edition, 2608.500) מופיע בראש תוצאות השאילתה השנייה ועוסק במושג ההרחבה הכללי של Public Cloud; הוא אינו נוקב ב-MB_MIGO_BADI ולא צוטט כראיה. תצפית שלא צוטטה כראיה: בשאילתה 'BADI_MMIM_CHECK_MATDOC_ITEM' עם --product SAP_S4HANA_CLOUD (18 עד 19 תוצאות, המספר השתנה בין הרצות חוזרות) הרשומה 'App Extensibility: Post Goods Movement' (loio 85a220ae29a745aab169b630791d0487, 2608.500) נוקבת בסניפט ב-BADI_MMIM_CHECK_MATDOC_ITEM; היא לא נוספה כראיה ואינה מזכירה את MB_MIGO_BADI. מסקנה: היעדר אזכור של MB_MIGO_BADI תועד ב-On-Premise וב-Public Cloud; ל-Private Cloud לא בוצע חיפוש נפרד. הסטטוס נותר verification_required, ולא נוסף source רשמי.",
  },
  {
  ...
  },
  {
    ...
    evidence: [
      ...
      },
      {
        ...
        release: "2608.500",
        accessedAt: DATE24,
        claim: "רשומת החיפוש של help.sap.com במוצר SAP_S4HANA_CLOUD לנושא 'Extensibility' (deliverable: Extend and Integrate Your SAP S/4HANA Cloud Public Edition, גרסה 2608 Latest, versionId 2608.500, loio 533228e1e854433ab16d013f161ca509, תאריך 2026-09-10) הוחזרה בשאילתות 'Extensibility', 'extensibility key user developer side-by-side' ו-'customer exit classic extension public cloud'. בסניפטים שלה (הנחתכים לפי השאילתה) מופיעים כלשונם: 'Compare the extensibility options in the following table: Key User Extensibility Developer Extensibility Side-by-Side Extensibility'; 'Extensibility in SAP S/4HANA Cloud Public Edition consists of the following options: Key User Extensibility through built-in capabilities Developer Extensibility through' (הסניפט נקטע שם); 'The extensibility concept of SAP S/4HANA Cloud Public Edition enables lifecycle-stable software products. SAP software updates don't depend on extensions from customers or partners.' כלומר הסניפט מונה שלוש אפשרויות הרחבה: Key User, Developer ו-Side-by-Side. הסניפטים אינם מזכירים Customer Exit, SMOD, CMOD או CONFPP01 ואינם קובעים דבר על זמינות הטכניקה הקלאסית; העדר אזכור בסניפט אינו קביעה של SAP. גוף העמוד לא נקרא.",
        verificationLevel: "verification_required"
      },
      {
        sourceType: "repository",
  ...
  },
  {
    ...
    status: {
      ...
      source: {
        ...
        release: "2025.001",
        accessedAt: DATE24,
        claim: "רשומת החיפוש של העמוד 'Enhancements Using Customer Exits (BOMs)' (loio e504c453f57eb44ce10000000a174cb4, תאריך 2026-02-24) מופיעה בתיעוד SAP S/4HANA On-Premise 2025 FPS01 וקובעת: 'In order to optimize the BOM processing processes in your business, you can change some functions of the SAP System in BOMs by using Customer Exits'. הסניפט מציג את הטבלה 'Enhancements for Function Group XCSA' בעמודות Description / Enhancement / Function Modules, ובה: 'Enhance maintenance of material BOMs PCSD0001 EXIT_SAPLCSDI_001', ואחריה 'Customer fields in item PCSD0002', ולאחר סימן השמטה בסניפט 'EXIT_SAPLCSDI_002 EXIT_SAPLCSDI_003 Customer fields in header PCSD0003 EXIT_SAPLCSDI_004 EXIT_SAPLCSDI_005 BOM comparison PCSD0004 EXIT_RCS14001_001 EXIT_RCS14001_002'; בחלון סניפט שני של אותו loio מופיעות גם השורות 'Component check for material items PCSD0005 EXIT_SAPLCSDI_006', 'Mass Changes PCSD0006 EXIT_SAPMC29M_001', 'Check on the changes to BOM header PCSD0007 EXIT_SAPLCSDI_007' ו-'PCSD0010 EXIT_SAPLCSSO_002'. כלומר ההרחבה PCSD0002 מתועדת בגרסת 2025 FPS01 בתיאור 'Customer fields in item'. גוף העמוד לא נקרא (מעטפת JavaScript), ובסניפטים לא הופיעה הצהרה על הוצאה משימוש, הגבלה או יורש. ב-2026-09-24 השאילתה 'PCSD0002' החזירה את אותו loio וגרסה 2025.001 תחת חבילת Product Lifecycle Management (PLM), וסניפט טבלת XCSA הדפיס את השורה Customer fields in item PCSD0002; השאילתה 'Enhancement Framework customer exits BOM item' החזירה את אותו loio תחת חבילת Document Management, והסניפט שלה נקטע לפני שורת PCSD0002. כתובת ה-URL המצוטטת (חבילת Bill of Material (LO-MD-BOM)) לא הוחזרה מחדש בשתי השאילתות.",
        verificationLevel: "sap_official_verified",
      },
      recommendedAction: "בהמרה: לשמר את מימוש ההרחבה הקיים ולבחון אותו בכלי Custom Code Migration ‏(SCMON/ATC) לפי הנחיית חוברת ההגירה בשורה 11, ולאמת ב-SMOD את רכיבי ההרחבה בגרסה המותקנת לפני שמסתמכים על תיאור הפרויקט. לפיתוח חדש בגישת Clean Core בתחום עצי מוצר, בצד On-Premise מציג תיעוד 2025 FPS01 שתי נקודות הרחבה מודרניות: BOM_BEFORE_SAVE (הגדרת BAdI תחת Enhancement Spot‏ ES_BOM_UPDATE, ממשק IF_BOM_BEFORE_SAVE, מתודה HANDLE_BEFORE_SAVE) לוולידציה של עץ המוצר לפני שמירה, ו-BOM_UPDATE (מתודה CHANGE_ADD_SAVE) ליצירת אירוע המפעיל workflow בעקבות שינוי בעץ; בצד Public Cloud מתעד What's New לגרסת 2408.1 (HFC5) את ה-BAdI BOM_BEFORE_UPDATE (Validate BOM Before Updating), המאפשר עדכון נתוני כותרת ופריט של עץ המוצר לפני שמירה, מסופק לצורך Key User Extensibility ונגיש דרך אפליקציית Custom Logic. אף אחד מהעמודים הרשמיים שצוטטו אינו מגדיר את עצמו כיורש של PCSD0002 (לא ב-On-Premise ולא ב-Public Cloud), ולכן לא נרשם successor. לתיקון רובד הפרויקט: השם BADI_BOM_CHANGES שברשומת הקטלוג לא אותר כטוקן עצמאי באף כותרת או סניפט שנסרקו ויש להחליפו בשם מאומת או לסמנו כדורש אימות ב-SE18, ותיאור המטרה ('ולידציה של פריטי עץ מוצר') אינו תואם את התיאור הרשמי 'Customer fields in item', שבו הבדיקה על רכיבי חומר מיוחסת להרחבה אחרת (PCSD0005).",
    },
    evidence: [
      {
        sourceType: "sap_help",
      ...
      {
        sourceType: "sap_help",
        sourceTitle: "BAdI for Validating Bill of Material | What's New in SAP S/4HANA Cloud 2408.1",
        url: "https://help.sap.com/docs/SAP_S4HANA_CLOUD/ee9ee0ca4c3942068ea584d2f929b5b1/d59cc5812c82427b8f6189082477a8e5.html?locale=en-US&state=PRODUCTION&version=2408.05",
        product: "SAP S/4HANA Cloud Public Edition",
        edition: "public-cloud",
        release: "2408.05",
        accessedAt: DATE24,
        claim: "רשומת What's New 'BAdI for Validating Bill of Material' (loio d59cc5812c82427b8f6189082477a8e5, גרסה 2408.1 (HFC5), versionId 2408.05) במהדורת SAP S/4HANA Cloud Public Edition קובעת: 'The new Business Add-In (BAdI) Validate BOM Before Updating (BOM_BEFORE_UPDATE) enables you to update the BOM header and BOM item details before saving'; 'The BAdI is delivered for key user extensibility'; 'You can find the BAdI in the Custom Logic app'; רכיב היישום PLM-FIO-BOM (Bills of Material). הסניפט אינו נוקב ב-PCSD0002 ואינו מגדיר קשר בינו לבין הרחבת לקוח כלשהי.",
        verificationLevel: "sap_official_verified",
      },
      {
        sourceType: "repository",
