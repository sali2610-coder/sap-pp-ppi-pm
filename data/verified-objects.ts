...
export const VERIFIED_OBJECTS: VerifiedObject[] = [
  ...
  },
  {
    ...
    ecc: "קיים ב-ECC.", s4: "ב-S/4HANA שורות היומן נרשמות ב-ACDOCA, ו-BSEG עדיין קיימת לשמירת מסמכי המקור שמהם נוצרות רשומות היומן (Universal Journal: FAQ, 2025.001).",
  ...
  },
  {
    ...
    ecc: "לא קיים ב-ECC.", s4: "טבלת ליבה של S/4HANA Finance: שורות היומן האוניברסלי (FI ו-CO). BKPF נשארת ללא שינוי ו-BSEG עדיין קיימת למסמכי המקור (Universal Journal: FAQ, 2025.001).",
