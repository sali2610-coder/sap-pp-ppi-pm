...
export const LIFECYCLE: Record<string, Lifecycle> = {
  ...
  "MB03": { status: "Obsolete", ecc: true, s4: false, fiori: "Material Documents Overview (F1077)", alt: "MIGO / MB51", simplification: "MM-IM", migration: "הוסר — הצגת מסמך דרך MIGO/Fiori.", impact: "Low" },
  ...
  // ---- Purchasing ----
  "ME21": { status: "Deprecated", ecc: true, s4: false, alt: "ME21N", migration: "לפי פריט הפישוט 'S4TWL - Classic MM-PUR GUI Transactions replacement' (2025 FPS01 14.2.8) הטרנזקציות הקלאסיות 'are NO longer supported' ב-S/4HANA On-Premise; השתמש ב-ME21N (Enjoy).", impact: "Medium" },
  "ME22": { status: "Deprecated", ecc: true, s4: false, alt: "ME22N", migration: "לפי פריט הפישוט 'S4TWL - Classic MM-PUR GUI Transactions replacement' (2025 FPS01 14.2.8) הטרנזקציות הקלאסיות 'are NO longer supported' ב-S/4HANA On-Premise; השתמש ב-ME22N.", impact: "Medium" },
  "ME23": { status: "Deprecated", ecc: true, s4: false, alt: "ME23N", migration: "לפי פריט הפישוט 'S4TWL - Classic MM-PUR GUI Transactions replacement' (2025 FPS01 14.2.8) הטרנזקציות הקלאסיות 'are NO longer supported' ב-S/4HANA On-Premise; השתמש ב-ME23N.", impact: "Low" },
  ...
  "IW31": { status: "Active", ecc: true, s4: true, fiori: "Manage Maintenance Orders (F5241)", migration: "נתמך; UX מומלץ Fiori EAM.", impact: "Low" },
