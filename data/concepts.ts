...
export const CONCEPTS: Concept[] = [
  ...
  { slug: "resource", title: "Resource", he: "משאב (Resource)", group: "PM/PP",
    biz: "מרכז עבודה בייצור תהליכי (PP-PI) — יחידת ייצור/קיבולת.", tech: "וריאנט של Work Center לתעשייה תהליכית (CRHD); משויך למתכון אב.", ecc: "CRC1.", s4: "ללא שינוי מהותי.", examples: ["משאב במתכון אב", "קו מילוי"], related: ["work-center", "process-order"] },
  ...
  { slug: "package", title: "Package", he: "חבילה (Package)", group: "Code",
    biz: "מארגנת אובייקטי פיתוח לוגית ושולטת בנראות/תלות ביניהם.", tech: "SE80/SE21; Development Class לשעבר; Package Interfaces; משויכת ל-Transport Layer.", ecc: "סטנדרטי.", s4: "ללא שינוי.", examples: ["חבילת פיתוחי PM", "חבילת ממשקי הארגון"], related: ["transport-request", "class"] },
