...
export const PPDS_TEXTBOOK: Record<string, TextbookChapter> = {
  "1": CH1,
  "2": CH2,
  "3": CH3,
  "4": CH4,
...
export const PPDS_TEXTBOOK_STATS = Object.fromEntries(
  Object.entries(PPDS_TEXTBOOK).map(([ch, c]) => {
