...
export const CH18: TextbookChapter = {
  ...
  titleEn: "Conclusion",
  introHe:
    "פרק הסיום אינו עוד פרק-קונפיגורציה אלא יחידת-לימוד שמחברת את כל מה שנלמד למבט-עתיד. שני תת-הפרקים שלו מעמיקים בכיוון שאליו צועד תחום ה-Sourcing & Procurement ב-SAP S/4HANA: כיצד פתרונות-הרכש עצמם משתנים (AI, Joule, autonomous sourcing, SAP Business Network) וכיצד שרשרת-האספקה של הרכש הופכת מחוברת, חזויה ואוטונומית. כל תת-פרק נכתב כיחידה עצמאית בת 18 מקטעים — שלוש רמות הסבר, מטרה עסקית, דוגמת-תהליך, דוגמת הארגון, ניווט, אובייקטים, מפת-דרכים (roadmap), טעויות נפוצות, פתרון-תקלות, שיטות-מומלצות, שאלות-ראיון ומסקנות-מפתח — כדי שניתן יהיה להבין לאן הולך הרכש בלי תלות במקור. ההסברים מתאימים גם למתחיל וגם ליועץ, והדוגמאות נטועות בעולם ה-Example Product bottling.",
  subchapters: [
    // ============================================================ 18.1
    {
      id: "18.1",
    ...
    // ============================================================ 18.2
    {
      ...
      scenarioHe:
        "בארגון: ספק-הסוכר משתף דרך SAP Business Network שצפוי עיכוב-קציר עונתי. ה-predictive layer מזהה סיכון-מחסור לקווי-המילוי, ומפעיל Quota Arrangement להסטת חלק מהאספקה לספק-סוכר משני. במקביל, ספק-הפקקים מקבל את תחזית-המכירות של הארגון בזמן-אמת ומתאם ייצור — מה שמקטין הן מלאי-פקקים עודף והן סיכון לעצירת-קו לפני פסח/קיץ.",
      navHe: [
