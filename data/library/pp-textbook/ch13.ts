...
export const CH13: TextbookChapter = {
  ...
  subchapters: [
    // ============================================================ 13.1
    {
      ...
      scenarioHe:
        "בארגון הרצת-MRP לילית מתרגמת את תחזית-המכירות (PIR) של כל SKU-משקה לתוכנית-מילוי לקווי-הייצור ולדרישות-רכש לתרכיז, סוכר, CO2 ואריזה. ה-MRP מבטיח שחומרי-הגלם יגיעו בזמן לקווי-המילוי בלי ניפוח-מלאי של חומרים בעלי תוקף.",
      navHe: [
    ...
    // ============================================================ 13.2
    {
      ...
      scenarioHe:
        "בארגון משקאות מוגמרים ותרכיזים = PD (מונעי-ביקוש מהתחזית); חומרי-עזר זולים כמו דבק-תוויות או חומרי-ניקוי = VB/VM (נקודת-הזמנה). כך מנהלי-התכנון מתמקדים בחומרים הקריטיים בלבד.",
      navHe: [
      ...
      children: [
        {
          ...
          scenarioHe: "בארגון כל המשקאות המוגמרים והתרכיזים מתוכננים ב-PD — הם מונעי-תחזית-מכירות ודורשים תזמון מדויק לקווי-המילוי.",
        ...
        },
        {
          ...
          scenarioHe: "בארגון חומרי-ניקוי, סיכה וחלקי-עזר זולים מנוהלים ב-VB עם Reorder Point ידני — חוסך תכנון פרטני לכל פריט-C.",
          navHe: ["Production ► MRP ► Master Data ► Check MRP Types (OMDQ)"],
          tables: ["T438A", "MARC"],
          tcodes: ["OMDQ", "MM02", "MD04"],
          fiori: ["F1422"],
        ...
        },
        {
          ...
          scenarioHe: "בארגון חומרי-עזר עם צריכה עונתית (למשל אריזות-קיץ) מנוהלים ב-VM — הסף עולה אוטומטית לפני העונה ויורד אחריה.",
        ...
        },
        {
          ...
          scenarioHe: "בארגון פריט-עזר עם הזמנות-העברה בין-מפעלים מנוהל ב-V1 — נקודת-הזמנה רגילה, אך העברה גדולה מתוכננת נלקחת בחשבון.",
          navHe: ["Production ► MRP ► Master Data ► Check MRP Types (OMDQ)"],
          tables: ["T438A", "MARC"],
          tcodes: ["OMDQ", "MM02", "MD04"],
          fiori: ["F1422"],
        ...
        },
        {
          ...
          scenarioHe: "בארגון פריט-עזר עונתי שגם מועבר בין-מפעלים מנוהל ב-V2 — סף אוטומטי-עונתי בתוספת התחשבות בהעברות מתוכננות.",
          navHe: ["Production ► MRP ► Master Data ► Check MRP Types (OMDQ)", "Production ► MRP ► Forecast"],
          tables: ["T438A", "MARC", "PROP"],
          tcodes: ["OMDQ", "MP30", "MM02"],
          fiori: ["F1422"],
        ...
        },
        {
          ...
          scenarioHe: "בארגון חומר-גלם מספק עם מסלול-חלוקה שבועי קבוע מנוהל ב-D1/D2 עם Planning Calendar — הזמנות מקובצות למועד-המשלוח השבועי.",
    ...
    // ============================================================ 13.3
    {
      ...
      scenarioHe:
        "בארגון רוב פריטי-MRO (תחזוקה, ניקוי, חלפים) מנוהלים מבוסס-צריכה — הם נצרכים באופן חוזר אך אינם חלק מ-BOM של מוצר, ולכן אין להם דרישות-עתידיות גלויות.",
      navHe: [
        "Production ► MRP ► Master Data ► Check MRP Types (OMDQ)",
      ...
      children: [
        {
          ...
          scenarioHe: "בארגון חומרי-עזר בעלי-צריכה חודשית קבועה (למשל חומרי-מעבדה) מנוהלים ב-VV — דרישה חודשית-חזויה שמתורגמת להצעות-רכש סדירות.",
          navHe: ["Production ► MRP ► Master Data ► Check MRP Types (OMDQ)", "Production ► MRP ► Forecast"],
        ...
        },
        {
          ...
          scenarioHe: "בארגון חומר-עזר בצריכה-חוזרת מספק עם משלוח חודשי-קבוע מנוהל ב-R1/R2 — דרישות חזויות מקובצות למועד-המשלוח החודשי.",
    ...
    // ============================================================ 13.4
    {
      ...
      scenarioHe:
        "בארגון ABC על מצאי-החומרים מראה שתרכיזים ואריזות-מפתח הם A (תכנון PD הדוק), בעוד חומרי-ניקוי וחלפים זולים הם C (VB אוטומטי) — מיקוד נכון של צוות-התכנון.",
      navHe: [
    ...
    // ============================================================ 13.5
    {
      ...
      scenarioHe:
        "בארגון משקאות מתוכננים PD; גודל-האצווה נגזר מקיבולת-קו-המילוי (אצווה-מינימלית/כפולות). חומרי-אריזה לעיתים בשיטה-תקופתית-שבועית כדי לקבץ משלוחים.",
      navHe: [
        "Production ► MRP ► Master Data ► Check MRP Types (OMDQ)",
      ...
      children: [
        {
          ...
          scenarioHe: "בארגון משקה בקיבולת-מינימלית-קבועה של אצוות-מילוי משתמש ב-Fixed/Rounding; מחסן-חומרי-עזר עם Replenish-to-maximum.",
        ...
        },
        {
          ...
          scenarioHe: "בארגון חומרי-אריזה מסופקים שבועית; WB מקבץ את כל דרישות-השבוע למשלוח-אחד — פחות תנועות-קבלה ופחות עלות-לוגיסטית.",
          navHe: ["Production ► MRP ► Planning ► Lot-Size Calculation ► Check Lot-Sizing Procedure (OMI4)"],
        ...
        },
        {
          ...
          scenarioHe: "בארגון רלוונטי לתרכיז יקר עם דרישות-תנודתיות — אופטימיזציה מאזנת בין עלות-החזקת-מלאי-יקר לבין עלות-הקמת-קו.",
          navHe: ["Production ► MRP ► Planning ► Lot-Size Calculation ► Check Lot-Sizing Procedure (OMI4)"],
          tables: ["T449L", "MARC"],
          tcodes: ["OMI4", "MM02"],
          fiori: ["F1422"],
        ...
        },
        {
          ...
          scenarioHe: "בארגון מגדירים קודי-Lot-Size ייעודיים: 'אצוות-מילוי' עם Rounding לקיבולת-קו, ו'אריזה-שבועית' עם צבירה-תקופתית — אחידות בין כל המשקאות.",
          navHe: ["Production ► MRP ► Planning ► Lot-Size Calculation ► Check Lot-Sizing Procedure (OMI4)"],
          tables: ["T449L", "MARC"],
          tcodes: ["OMI4", "MM02"],
          fiori: ["F1422"],
    ...
    // ============================================================ 13.6
    {
      ...
      scenarioHe:
        "בארגון PTF של מספר-ימים מקפיא את תוכנית-המילוי הקרובה — קווי-הייצור וצוותי-המשמרת יודעים מה מיוצר השבוע, וה-MRP מתכנן רק את העתיד-הרחוק יותר.",
      navHe: [
        "Production ► MRP ► Master Data ► Check MRP Types (OMDQ)",
    ...
    // ============================================================ 13.7
    {
      ...
      scenarioHe:
        "בארגון חומרי-עזר זולים מנוהלים בנקודת-הזמנה; פחת-רכיב ~1-2% על חומרי-אריזה (בקבוקים/תוויות פגומים) מוזן כ-Component Scrap כדי שהמילוי לא ייעצר בגלל מחסור-אריזה.",
      navHe: [
        "Production ► MRP ► Master Data ► Check MRP Types (OMDQ)",
      ...
      children: [
        {
          ...
          scenarioHe: "בארגון משקה עם פסילת-QA צפויה של ~2% מקבל Assembly Scrap 2% — מתכננים מעט-יותר מילוי כדי לעמוד בהזמנות אחרי פסילות.",
        ...
        },
        {
          ...
          scenarioHe: "בארגון בקבוקים/תוויות/פקקים מקבלים Component Scrap 1-2% — פחת-אריזה אופייני — בלי להגדיל את התרכיז שאינו מתבזבז.",
        ...
        },
        {
          ...
          scenarioHe: "בארגון פעולת-מילוי עם פסילה-בשלב מקבלת Operation Scrap; אריזה הנצרכת באותה פעולה מתואמת אוטומטית — מידול נאמן של אובדן-קו.",
        ...
        },
        {
          ...
          scenarioHe: "בארגון קו-מילוי רב-שלבי (שטיפה→מילוי→הגפה→תיוג) — פחת-פעולה בכל שלב מצטבר; ה-MRP מתכנן קלט מספיק כדי שבסוף-הקו תתקבל הכמות הנדרשת.",
    ...
    // ============================================================ 13.8
    {
      ...
      scenarioHe:
        "בארגון חומרי-עזר קריטיים-לקו (אך זולים) מקבלים מלאי-בטחון לכיסוי תנודות-אספקה — מילוי-קו לא נעצר בגלל איחור-משלוח של פריט-עזר.",
      navHe: [
        "Production ► MRP ► Master Data ► Check MRP Types (OMDQ)",
      ...
      children: [
        {
          ...
          scenarioHe: "בארגון חומר-עזר יציב מקבל מלאי-בטחון סטטי קבוע — פשוט להגדרה ולתחזוקה.",
        ...
        },
        {
          ...
          scenarioHe: "בארגון לפריטים עם רזרבה גדולה מגדירים Availability חלקי — חלק מהרזרבה משרת תנודות-יום-יום בלי לפתוח הזמנות מיותרות.",
        ...
        },
        {
          ...
          scenarioHe: "בארגון חומרי-עזר עונתיים מנוהלים עם פרופיל-טווח-כיסוי — הרזרבה גדלה לפני העונה ומצטמצמת אחריה, בלי התערבות ידנית.",
        ...
        },
        {
          ...
          scenarioHe: "בארגון חומר-גלם מספק לא-יציב-במועדים מקבל Safety Time — האספקות מוקדמות, וקווי-המילוי לא נעצרים בגלל איחור-משלוח.",
        ...
        },
        {
          ...
          scenarioHe: "בארגון חומרי-מפתח מקבלים מלאי-בטחון מחושב-סטטיסטית לרמת-שירות גבוהה — איזון מיטבי בין סיכון-מחסור-לקו לעלות-החזקה.",
    ...
    // ============================================================ 13.9
    {
      ...
      scenarioHe:
        "בארגון כל פריטי-העזר מבוססי-הצריכה מנוהלים כך: קו-מינימום, רזרבה וגודל-הזמנה קבוע — מנהל-המחסן רואה הכל ב-MD04 ומאשר הצעות-חידוש בלחיצה.",
      navHe: [
        "Production ► MRP ► Master Data ► Check MRP Types (OMDQ)",
        "Production ► MRP ► Evaluations ► Stock/Requirements List (MD04)",
      ],
