...
export const CH5: TextbookChapter = {
  ...
  subchapters: [
    // ============================================================ 5.1
    {
      ...
      tcodes: ["OSP2", "MM02", "MFBF", "MF50", "COGI"],
      fiori: ["F2336", "F1422"],
      configHe: [
        "OSP2: הגדרת REM Profile עם כל אינדיקטורי-הביצוע — Production Type, Reporting Points, Auto goods movements, Activity posting, Separated backflush.",
      ...
      flow: [
        { he: "הגדרת פרופיל", code: "OSP2", note: "T437" },
      ...
      interviewHe: [
        { qHe: "מהו REM Profile והיכן מקצים אותו?", aHe: "רשומת-קונפיגורציה (OSP2/T437) שקובעת את התנהגות-הביצוע של ייצור-חוזר; מוקצית לאב-החומר בשדה MARC-SFEPR בתצוגת MRP 4." },
      ...
      takeawaysHe: [
        "REM Profile = רשומת-העל של התנהגות-הביצוע בייצור-חוזר (OSP2/T437).",
      ...
      children: [
        {
          ...
          tcodes: ["OSP2", "MM02"],
          fiori: ["F1422"],
          configHe: ["ב-OSP2 קבע Production Type לפרופיל; תאם עם REM Indicator (MARC-SAUFT) ו-Strategy Group."],
