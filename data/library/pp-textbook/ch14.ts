...
export const CH14: TextbookChapter = {
  ...
  subchapters: [
    ...
    // ============================================================ 14.3
    {
      ...
      tables: ["MARC", "PPH_DD_BUFFER", "T457D"],
      tcodes: ["MD04", "OMDD"],
    ...
    // ============================================================ 14.4
    {
      ...
      consultantHe:
        "מיפוי-יישום: רכיבים 1–2 (מיקום+גדלים) → Buffer Profile (OMDD) + DD-relevance; רכיב 3 (Dynamic Adjustment) → DAF/Lead Time/Variability factors; רכיב 4 (Planning) → אפליקציית Replenishment Planning; רכיב 5 (Execution) → Replenishment Execution + Manage Buffer Levels. הכל נסמך על PPH_DD_BUFFER.",
      purposeHe:
      ...
      navHe: [
        "SPRO ► Production ► MRP ► Demand-Driven Replenishment ► General Settings / Buffer Proposal (OMDD)",
        "SAP Fiori ► Demand-Driven Replenishment catalog (PP-DD)",
      ],
      tables: ["T457D", "PPH_DD_BUFFER", "MARC"],
      tcodes: ["OMDD", "MD04"],
      ...
      children: [
        {
          ...
          execHe: "רובד-הקונפיגורציה ב-SPRO/OMDD: הגדרת Buffer Profiles, פקטורי-Lead-Time וה-Variability, סיווגי-Lead-Time, ופרמטרי-Net-Flow כלל-מפעליים. זהו הבסיס שעליו נשען חישוב-הבאפר.",
          ...
          consultantHe: "ב-OMDD מגדירים Buffer Profile עם Lead Time Category, Variability Category, Order Cycle, Minimum Order Qty ופקטורי-אזורים. הגדרות-מפעל (Plant-specific) מכוונות סיווגי-LT וספי-תנודתיות. הטבלה: T457D.",
          ...
          navHe: ["SPRO ► Production ► MRP ► Demand-Driven Replenishment ► Maintain Buffer Proposal Profiles (OMDD)"],
          tables: ["T457D"],
          tcodes: ["OMDD"],
          fiori: ["F2228"],
          configHe: ["ב-OMDD הגדר Buffer Profile: Lead Time Cat, Variability Cat, Order Cycle, MOQ, Lead-Time-Factor, Variability-Factor.", "הגדר סיווגי-LT וספי-תנודתיות ברמת-המפעל."],
          mistakesHe: ["פקטורי-אזורים קיצוניים ➔ באפר מנופח או רזה מדי.", "אי-התאמת סיווגי-LT למציאות-האספקה."],
          troubleshootHe: ["באפרים גדולים/קטנים מהצפוי ➔ פקטורי-LT/Variability בפרופיל; כוון ב-OMDD."],
          bestPracticeHe: ["התחל מפקטורי-ברירת-מחדל של DDI ואז כוון בנתונים.", "מעט פרופילים ככל האפשר — פחות שונות."],
          interviewHe: [{ qHe: "מה מגדירים ב-OMDD?", aHe: "Buffer Profiles עם קטגוריות-LT/Variability ופקטורי-אזורים — מסגרת-החישוב לכל חומר משויך." }],
          takeawaysHe: ["OMDD = הגדרת Buffer Profiles.", "פקטורי-LT/Variability קובעים גודל-אזורים.", "טבלה: T457D."],
        },
        {
    ...
    // ============================================================ 14.5
    {
      ...
      children: [
        ...
        },
        {
          ...
          consultantHe: "ב-OMDD מגדירים Lead Time Categories עם טווחי-ימים ופקטורים. ה-Lead Time Factor מוכפל ב-(ADU × DLT) לחישוב אזור-הירוק והאדום-הבסיסי. סיווג שגוי מעוות את כל האזורים.",
          ...
          navHe: ["SPRO ► ... ► Demand-Driven Replenishment ► Lead Time Categories (OMDD)"],
          tables: ["T457D", "PPH_DD_BUFFER"],
          tcodes: ["OMDD"],
          fiori: ["F2228"],
          configHe: ["ב-OMDD הגדר Lead Time Categories עם טווחי-DLT ופקטורים (Short/Medium/Long)."],
          ...
          takeawaysHe: ["LT מסווג לקצר/בינוני/ארוך.", "Factor משפיע על ירוק+אדום.", "מוגדר ב-OMDD."],
        },
        {
    ...
    // ============================================================ 14.6
    {
      ...
      configHe: [
        "האזורים נגזרים מ-Buffer Profile (פקטורי LT/Variability/Order-Cycle/MOQ) שב-OMDD.",
    ...
    // ============================================================ 14.9
    {
      ...
      consultantHe:
        "ב-OMDD מגדירים Buffer Profile עם: Lead Time Category+Factor, Variability Category+Factor, Order Cycle (תדירות-הזמנה רצויה), ו-Minimum/Maximum Order Quantity. אלו מזינים את נוסחאות-האזורים. הטבלה T457D. פרופיל-סטנדרטי משמש כבסיס-העתקה.",
      purposeHe:
      ...
      navHe: ["SPRO ► Production ► MRP ► Demand-Driven Replenishment ► Maintain Buffer Profiles (OMDD)"],
      tables: ["T457D", "PPH_DD_BUFFER"],
      tcodes: ["OMDD"],
      fiori: ["F2228", "F2229"],
      configHe: [
        "ב-OMDD: צור Buffer Profile עם Lead Time+Variability Categories ופקטורים, Order Cycle, MOQ.",
      ...
      troubleshootHe: [
        "אזורים שגויים לכל משפחה ➔ פקטורי-הפרופיל; כוון ב-OMDD.",
      ...
      interviewHe: [
        { qHe: "מהו Buffer Profile?", aHe: "צרור-פקטורים (LT, Variability, Order Cycle, MOQ) שמחושבים לפיו אזורי-הבאפר לכל חומר משויך; מוגדר ב-OMDD." },
      ...
      children: [
        {
          ...
          consultantHe: "ברמת-המפעל (T457D plant-key) מגדירים את גבולות סיווגי-ה-LT/Variability ואת ברירות-מחדל-ה-Spike. כך אותו Buffer Profile מניב אזורים מותאמים-מפעל. חשוב בארגון רב-אתרי.",
          ...
          navHe: ["SPRO ► ... ► Demand-Driven Replenishment ► Plant-Specific Buffer Settings (OMDD)"],
          tables: ["T457D", "PPH_DD_BUFFER"],
          tcodes: ["OMDD"],
          fiori: ["F2228"],
          configHe: ["ברמת-המפעל ב-OMDD הגדר ספי-LT, ספי-Variability ופרמטרי-Spike מקומיים."],
