// ===== PM User-Guide Digital Textbook — barrel =====
...
export const PMU_TEXTBOOK: Record<string, TextbookChapter> = {
  "1": CH1,
  "2": CH2,
  "3": CH3,
  "4": CH4,
...
export const PMU_TEXTBOOK_STATS = Object.fromEntries(
  Object.entries(PMU_TEXTBOOK).map(([ch, c]) => {
