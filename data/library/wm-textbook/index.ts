// ===== WM/EWM Digital Textbook — barrel =====
...
export const WM_TEXTBOOK: Record<string, TextbookChapter> = {
  "1": CH1,
  "2": CH2,
  "3": CH3,
  "4": CH4,
...
export const WM_TEXTBOOK_STATS = Object.fromEntries(
  Object.entries(WM_TEXTBOOK).map(([ch, c]) => {
