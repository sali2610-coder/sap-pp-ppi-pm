...
export const CH6: TextbookChapter = {
  ...
  subchapters: [
    // ============================================================ 6.1
    {
      ...
      scenarioHe:
        "בארגון: כל FERT (משקה מוגמר) מנוהל-אצווה מקבל בתצוגת-QM סוג-בדיקה 10 פעיל. כך כל משלוח לרשת-קמעונאות מייצר מנת-בדיקה היוצקת בדיקות-שחרור (תוקף-אצווה, שלמות-אריזה, סימון). סוג 11 מופעל לטיפול בהחזרות-לקוח (מוצר שחזר מהרשת).",
      navHe: [
    ...
    // ============================================================ 6.2
    {
      ...
      scenarioHe:
        "בארגון: כל FERT נושא Inspection Plan סוג Q עם MICs — תוקף-אצווה, רמת-מילוי, שלמות-פקק, קריאות-תווית/ברקוד. רשתות-קמעונאות גדולות מוגדרות כ-Customers הדורשים Quality Certificate; פרופיל-התעודה כולל את תוצאות-ה-MIC הרלוונטיות.",
      navHe: [
    ...
    // ============================================================ 6.3
    {
      ...
      scenarioHe:
        "בארגון כל יציאת-משקה לרשת עוברת את המסלול האחיד; ההבדל הוא רק האם זו הזמנה רגילה (6.3.1), העברה-פנימית בין מחסנים ללא SO (6.3.2/6.3.4), או החזרה מהרשת (6.3.3, סוג 11).",
      navHe: [
      ...
      children: [
        // -------------------------------------------------- 6.3.1
        {
          ...
          scenarioHe:
            "בארגון רשת-קמעונאות מזמינה 5,000 ארגזי-משקה. נפתח משלוח, נוצרת מנת-בדיקה סוג 10 הבודקת תוקף-אצווה ושלמות-אריזה; UD חיובי משחרר את ה-GI ומפיק תעודת-איכות לרשת.",
          navHe: [
        ...
        // -------------------------------------------------- 6.3.2
        {
          ...
          scenarioHe:
            "בארגון: העברת משקאות בין מרכז-הפצה לאזורי בלי הזמנת-לקוח רשמית — נוצר משלוח-ללא-הזמנה, מנת-בדיקה סוג 10 בודקת תוקף-אצווה לפני יציאת המלאי בין-האתרים.",
          navHe: [
        ...
        // -------------------------------------------------- 6.3.3
        {
          ...
          scenarioHe:
            "בארגון רשת מחזירה משקאות פגי-תוקף או פגומי-אריזה. נוצרת הזמנת-החזרה ומשלוח-החזרה; מנת-בדיקה סוג 11 בודקת תוקף ושלמות — מוצר פג-תוקף מנותב ל-scrap, מוצר תקין חוזר למלאי.",
          navHe: [
        ...
        // -------------------------------------------------- 6.3.4
        {
          ...
          scenarioHe:
            "בארגון משלוח-דגימות-משקה לתערוכה או לבדיקת-לקוח-חדש: Delivery גנרי הוקצה ל-Inspection Type 10, מנת-בדיקה מוודאת שגם הדגימות תקינות לפני שהן עוזבות את המפעל.",
          navHe: [
    ...
    // ============================================================ 6.4
    {
      ...
      scenarioHe:
        "בארגון: כל משקה שיוצא לרשת-קמעונאות עובר את שער-האיכות (סוג 10) עם תעודת-איכות; כל החזרה (סוג 11) נבדקת ומנותבת. כך הארגון מבטיח שלא יוצא ולא חוזר למלאי מוצר פג-תוקף או פגום.",
      navHe: [
        "Quality Management ► Quality Inspection ► Inspection Lot Creation ► Inspection for Delivery",
