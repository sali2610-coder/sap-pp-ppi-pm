// ===== S&OP/IBP Digital Textbook — barrel =====
...
export const SOP_TEXTBOOK: Record<string, TextbookChapter> = {
  "1": CH1,
  "2": CH2,
  "3": CH3,
  "4": CH4,
...
export const SOP_TEXTBOOK_STATS = Object.fromEntries(
  Object.entries(SOP_TEXTBOOK).map(([ch, c]) => {
