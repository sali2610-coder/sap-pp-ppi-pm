...
// Curated CBC (beverage manufacturing) examples per step — concrete, plant-floor
// scenarios. Supplemented at render time by real CBC examples from the incident KB.
export const STEP_CBC: Record<string, string> = {
  "pm-1": "ב-CBC כל קו מילוי הוא מיקום פונקציונלי; משאבה על הקו = ציוד תחתיו. תקלה נרשמת על הקו → ניתוח אמינות לפי קו.",
  ...
  "ppi-1": "אב החומר 'תרכיז קולה' עם מק\"ט CBC; נתוני המפעל (MARC) מגדירים ניהול אצוות ו-MRP.",
  ...
  "ppi-4": "פריט הפקודה = המוצר המוגמר 'קולה 0.5 ליטר'; הכמות והיעד למחסן מוגמר.",
