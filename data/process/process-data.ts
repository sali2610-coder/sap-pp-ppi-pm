...
// Curated הארגון (beverage manufacturing) examples per step — concrete, plant-floor
// scenarios. Supplemented at render time by real הארגון examples from the incident KB.
export const STEP_MFG: Record<string, string> = {
  "pm-1": "בארגון כל קו מילוי הוא מיקום פונקציונלי; משאבה על הקו = ציוד תחתיו. תקלה נרשמת על הקו → ניתוח אמינות לפי קו.",
  "pm-2": "משאבת תרכיז בקו 2 מוקמת כציוד ומותקנת במיקום הקו; היסטוריית התקלות שלה עוברת איתה גם אם מועברת לקו אחר.",
  "pm-3": "מפעיל מדווח דליפה במשאבה (IW21) → נפתחת הודעת אחזקה עם קוד נזק 'דליפה' לפני שהטכנאי מגיע.",
  "pm-4": "מההודעה נפתח צו אחזקה לתיקון המשאבה; הצו מתכנן חלפים (אטם) ושעות טכנאי.",
  "pm-5": "פעולות הצו: 1) ניתוק וניקוז 2) החלפת אטם 3) בדיקת אטימות — כל פעולה במרכז עבודה 'מכאנאים'.",
  "pm-6": "הטכנאי מדווח שעתיים עבודה וצריכת אטם (AFRU); המלאי יורד אוטומטית והעלות נצברת על הצו.",
  "pm-7": "בסיום, מנהל האחזקה מבצע TECO — הצו נעול לשינויים ומוכן לסגירת עלויות.",
  "pm-8": "עלות התיקון מתנקזת למרכז העלות של הייצור; דוח MTBF של המשאבות מתעדכן לקראת תכנון מונע.",
  "ppi-1": "אב החומר 'תרכיז מוגז' עם מק\"ט הארגון; נתוני המפעל (MARC) מגדירים ניהול אצוות ו-MRP.",
  "ppi-2": "מתכון המילוי: ערבוב תרכיז+מים מוגזים → מילוי בקבוקים → אריזה; כל Phase על משאב אחר.",
  "ppi-3": "MRP יוצר פקודה מתוכננת ל-10,000 בקבוקים; המתכנן ממיר אותה לפקודת תהליך (COR1).",
  "ppi-4": "פריט הפקודה = המוצר המוגמר 'מוגז 0.5 ליטר'; הכמות והיעד למחסן מוגמר.",
  "ppi-5": "כל ריצת מילוי מקבלת אצווה עם תאריך תפוגה (SLED); קביעת FEFO תבחר את האצווה הקרובה לפקיעה במשלוח.",
  "ppi-6": "בסוף המשמרת מאשרים את הפקודה (COR6N); Backflush מנכה תרכיז ובקבוקים אוטומטית.",
  "ppi-7": "כשנגמר תרכיז במחסן הקו, Backflush נכשל ונכנס ל-COGI; רכז המלאי מזין GR ומריץ COGI שוב.",
  "ppi-8": "בסוף החודש מחושבות סטיות צריכת התרכיז מול התקן; חריגה מובילה לבדיקת כיול מדי הזרימה.",
};
