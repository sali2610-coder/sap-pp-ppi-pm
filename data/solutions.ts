...
export const SOLUTIONS: Solution[] = [
  ...
  { slug: "goods-movement", domain: "MM", he: "תנועות מלאי", title: "Goods Movements (GR/GI/Transfer)", keywords: ["stock", "movement", "goods", "תנועה", "GR", "GI", "261", "101", "transfer", "קליטת סחורה", "קבלת טובין", "ניפוק"],
  ...
  { slug: "batch-management", domain: "PP-PI", he: "ניהול אצוות ומעקב", title: "Batch Management & Traceability", keywords: ["batch", "אצווה", "ניהול אצווה", "traceability", "מעקב", "FEFO", "recall", "shelf life", "SLED"],
