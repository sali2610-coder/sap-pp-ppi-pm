...
export const SOLUTIONS: Solution[] = [
  ...
  { slug: "batch-management", domain: "PP-PI", he: "ניהול אצוות ומעקב", title: "Batch Management & Traceability", keywords: ["batch", "אצווה", "ניהול אצווה", "פתיחת אצווה", "traceability", "מעקב", "FEFO", "recall", "shelf life", "SLED"],
    ...
    fiori: ["Manage Batches (F2462)", "Batch Information Cockpit"], tables: ["MCH1", "MCHA", "MCHB", "AUSP", "CHVW"], cds: ["I_Batch"], apis: ["API_BATCH_SRV"], bapis: ["BAPI_BATCH_CREATE", "BAPI_BATCH_GET_DETAIL", "VB_BATCH_DETAIL_GET"], exits: ["SAPLV01Z", "VB_BD_BATCH_DETERMINATION"], incidents: ["batch-determination-fail", "char-batch-classification-missing", "batch-derivation-fail"], complexity: "High" },
  { slug: "maintenance", domain: "PM", he: "אחזקת מפעל", title: "Plant Maintenance (Corrective & Preventive)", keywords: ["maintenance", "אחזקה", "תחזוקה מונעת", "אחזקה מונעת", "breakdown", "preventive", "equipment", "ציוד", "notification", "order"],
  ...
  { slug: "process-order", domain: "PP-PI", he: "פקודת תהליך", title: "Process Order & MES", keywords: ["process order", "פקודת תהליך", "אישור הזמנת ייצור", "recipe", "מתכון", "control recipe", "MES", "PI sheet"],
    process: "ייצור תהליכי מבוסס-מתכון — שחרור, מרשם בקרה ל-MES, אישור שלבים, GR לאצווה.",
    eccTcodes: ["COR1", "COR2", "COR6N", "CO53"], s4Alt: "נתמך; API_PROCESS_ORDER_2_SRV + Fiori; PP-DS/aATP.",
    fiori: ["Manage Process Orders (F3577)", "Confirm Process Order"], tables: ["AUFK", "AFKO", "AFPO", "AFRU", "MCH1"], cds: ["I_ManufacturingOrder"], apis: ["API_PROCESS_ORDER_2_SRV"], bapis: ["BAPI_PROCORD_CREATE", "BAPI_PROCORDCONF_CREATE_TT"], exits: ["PPCO0001", "CONFPP01", "WORKORDER_CONFIRM"], incidents: ["process-order-no-control-recipe", "process-message-not-sent", "phase-confirm-sequence", "cogi-stuck"], complexity: "High" },
  { slug: "mrp", domain: "PP", he: "תכנון דרישות (MRP)", title: "Material Requirements Planning", keywords: ["MRP", "תכנון", "planning", "MPS", "PIR", "demand", "תחזית", "MD04"],
    ...
    fiori: ["Monitor Material Coverage (Version 2) (F0247A)", "Manage Material Coverage"], tables: ["MDKP", "MDTB", "PLAF", "PBED", "MDVM"], cds: ["C_MRPMaterials"], apis: [], bapis: ["MD_CONVERT_MATERIAL_UNIT"], exits: ["M61X0001", "MD_PLDORD_POST"], incidents: ["mrp-no-planned-orders", "mrp-exception-messages", "no-production-version"], complexity: "High" },
  { slug: "quality-inspection", domain: "QM", he: "בדיקת איכות", title: "Quality Inspection (QM)", keywords: ["quality", "איכות", "ניהול איכות", "inspection", "בדיקה", "lot", "usage decision", "UD", "COA", "calibration"],
  ...
  { slug: "procurement", domain: "MM", he: "רכש (Procure-to-Pay)", title: "Procurement (P2P)", keywords: ["purchase", "רכש", "procurement", "PO", "requisition", "invoice", "P2P", "vendor"],
    ...
    fiori: ["Manage Purchase Orders (Version 2) (F0842A)", "Manage Purchase Requisitions"], tables: ["EBAN", "EKKO", "EKPO", "RBKP"], cds: [], apis: ["API_PURCHASEORDER_PROCESS_SRV"], bapis: ["BAPI_PO_CREATE1", "BAPI_REQUISITION_GETDETAIL"], exits: [], incidents: ["subcontracting-components", "pricing-condition-missing"], complexity: "Medium" },
  { slug: "sales-order", domain: "SD", he: "מכירות (Order-to-Cash)", title: "Sales (O2C)", keywords: ["sales", "מכירה", "order to cash", "תעודת משלוח", "delivery", "billing", "O2C", "customer"],
...
SOLUTIONS.push(
  { slug: "label-output", domain: "Cross", he: "הדפסת תוויות ופלט", title: "Label Printing & Output", keywords: ["label", "תווית", "הדפסת תווית", "print", "הדפסה", "output", "פלט", "NAST", "BRF+"],
    process: "הפקת פלט/תוויות — תעודות, הזמנות, תוויות אצווה/משלוח — דרך קביעת פלט (NAST) או Output Management החדש (BRF+/Adobe).",
    eccTcodes: ["NACE", "VF31", "SP01"], s4Alt: "Output Management חדש מבוסס BRF+ + Adobe Forms; NAST קלאסי לחלק מהאובייקטים.",
    fiori: ["Output Management (BRF+)", "Manage Output Items"], tables: ["NAST"], cds: [], apis: [], bapis: ["RV_MESSAGE_UPDATE"], exits: [], incidents: ["output-not-printed", "email-output-fail", "spool-overflow"], complexity: "Medium" },
);
