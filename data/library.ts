...
export const LIBRARY: LibBook[] = [
  ...
  },
  {
    ...
    chapters: [
      ...
      { n: 7, en: "Integrating Applications from Other Departments", he: "שילוב יישומים ממחלקות אחרות", page: 375 },
      { n: 8, en: "Plant Maintenance Controlling", he: "בקרת עלויות באחזקה (PM Controlling)", page: 437 },
      { n: 9, en: "New Information Technologies", he: "טכנולוגיות מידע חדשות", page: 495 },
  ...
  },
  {
    ...
    titleHe: "יסודות ל-SAP S/4HANA — מודול הגשר להכשרת יועצים (ZaranTech Foundation)",
    publisher: "ZaranTech",
    module: "Foundation",
    pages: 193,
    summaryEn: "The \"Week 0\" consultant foundation before the main SAP S/4HANA implementation journey: how enterprises are structured, business processes (P2P, O2C, R2R), why ERP exists, the SAP ecosystem and S/4HANA, system landscapes, clients and project roles, SAP GUI vs SAP Fiori navigation, core terminology, and the path from end user to implementation consultant.",
    summaryHe: "בסיס היועץ (\"שבוע 0\") טרם מסע היישום של SAP S/4HANA: כיצד ארגונים בנויים, תהליכים עסקיים (P2P, O2C, R2R), מדוע ERP קיים, האקוסיסטם של SAP ו-S/4HANA, System Landscapes, Clients ו-project roles, ניווט SAP GUI מול SAP Fiori, טרמינולוגיה ליבתית, והמעבר מ-end user ל-implementation consultant.",
    chapters: [
      { n: 1, en: "Understanding Modern Enterprises and Business Functions", he: "הבנת הארגון המודרני והפונקציות העסקיות", page: 3 },
      { n: 2, en: "From Functions to Business Processes", he: "מפונקציות לתהליכים עסקיים (P2P, O2C, R2R)", page: 25 },
      { n: 3, en: "Why ERP Exists and What Problems It Solves", he: "מדוע ERP קיים ואילו בעיות הוא פותר", page: 44 },
      { n: 4, en: "ERP Concepts and the SAP Ecosystem", he: "מושגי ERP והאקוסיסטם של SAP", page: 60 },
      { n: 5, en: "System Landscapes, Clients, and Project Roles", he: "System Landscapes, Clients ו-Project Roles", page: 83 },
      { n: 6, en: "SAP GUI and SAP Fiori – Navigating the SAP World", he: "SAP GUI ו-SAP Fiori — ניווט בעולם SAP", page: 105 },
      { n: 7, en: "SAP Terminology and Structures for New Consultants", he: "טרמינולוגיה ומבנים של SAP ליועצים חדשים", page: 125 },
      { n: 8, en: "From End User to Implementation Consultant", he: "מ-End User ל-Implementation Consultant", page: 148 },
      { n: 9, en: "Learning Strategy, Readiness Check, and Next Steps", he: "אסטרטגיית למידה, Readiness Check והצעדים הבאים", page: 165 },
    ],
  },
  {
