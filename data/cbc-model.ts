// CBC Domain Model — connects CBC plant areas to SAP modules, objects and
// process maps. Beverage-manufacturing oriented. Hand-authored.

export interface CbcLink { label: string; href: string }
export interface CbcArea {
  slug: string;
  he: string;
  title: string;
  ...
  objects: CbcLink[];       // SAP objects (→ /oic or /object)
  processes: CbcLink[];     // process maps / guides
  incidents: CbcLink[];
}

export const CBC_AREAS: CbcArea[] = [
  { slug: "production-line", he: "קו ייצור", title: "Production Line", modules: ["PP-PI", "PP", "MM"],
    ...
    processes: [{ label: "Plan-to-Produce", href: "/process-explorer/plan-to-produce/" }, { label: "ייצור משקה (CBC)", href: "/cbc/beverage-production/" }],
  ...
  { slug: "syrup-room", he: "חדר תרכיז", title: "Syrup Room", modules: ["PP-PI", "QM"],
    ...
    processes: [{ label: "תהליך תרכיז (CBC)", href: "/cbc/syrup-process/" }, { label: "Quality Management", href: "/process-explorer/quality-management/" }],
  ...
  { slug: "cip", he: "ניקוי במקום (CIP)", title: "Cleaning-in-Place", modules: ["PM", "QM"],
    ...
    processes: [{ label: "CIP (CBC)", href: "/cbc/cip/" }, { label: "Maintenance Management", href: "/process-explorer/maintenance-management/" }],
  ...
  { slug: "batch", he: "ניהול אצוות", title: "Batch Management", modules: ["PP-PI", "QM", "MM"],
    ...
    processes: [{ label: "מעקב אצוות (Blueprint)", href: "/blueprints/pppi-batch-trace/" }, { label: "אירוע איכות ו-Recall", href: "/cbc/quality-recall/" }],
  ...
  { slug: "packaging", he: "קו אריזה", title: "Packaging Line", modules: ["PP", "MM"],
    ...
    processes: [{ label: "קו אריזה (CBC)", href: "/cbc/packaging-line/" }, { label: "Discrete (MRP→Order)", href: "/process-explorer/plan-to-produce/" }],
  ...
  { slug: "quality", he: "מעבדת איכות", title: "Quality", modules: ["QM", "PP-PI"],
    ...
    processes: [{ label: "Quality Management", href: "/process-explorer/quality-management/" }, { label: "אירוע איכות (CBC)", href: "/cbc/quality-recall/" }],
